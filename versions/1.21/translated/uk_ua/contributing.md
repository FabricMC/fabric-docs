...
# Інструкції щодо внеску {#contributing}
...
1. <Badge type="tip">locally</Badge> Підготуйте свої зміни та проведіть PR
...
1. [Розгалуження сховища GitHub](https://github.com/FabricMC/fabric-docs/fork)
2. Створіть нову гілку у вашому розгалуженні
...
#### Клонування вашого розгалуження
