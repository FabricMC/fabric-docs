...
@[code transcludeWith=:::guidite_tool_material](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::7](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::8](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/item/guidite_sword.json)
