...
@[code transcludeWith=#entrypoint](@/reference/1.21.10/src/main/java/com/example/docs/enchantment/effect/LightningEnchantmentEffect.java)
...
@[code transcludeWith=#entrypoint](@/reference/1.21.10/src/main/java/com/example/docs/enchantment/ModEnchantmentEffects.java)
...
@[code transcludeWith=#entrypoint](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModEnchantmentGenerator.java)
...
@[code transclude={24-24}](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code](@/reference/1.21.10/src/main/generated/data/example-mod/enchantment/thundering.json)
