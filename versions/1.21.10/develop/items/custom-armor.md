...
@[code transcludeWith=:::material_key](@/reference/1.21.10/src/main/java/com/example/docs/item/armor/GuiditeArmorMaterial.java)
...
@[code transcludeWith=:::guidite_armor_material](@/reference/1.21.10/src/main/java/com/example/docs/item/armor/GuiditeArmorMaterial.java)
...
@[code transcludeWith=:::repair_tag](@/reference/1.21.10/src/main/java/com/example/docs/item/armor/GuiditeArmorMaterial.java)
...
<<< @/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModItemTagProvider.java#repair_tags
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/item/guidite_helmet.json)
...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/equipment/guidite.json)
