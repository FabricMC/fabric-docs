...
@[code transcludeWith=:::spawn_egg](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/item/custom_spawn_egg.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/items/custom_spawn_egg.json)
...
@[code transcludeWith=:::spawn_egg_creative_tab](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)

![Spawn egg item with name and creative tab](/assets/develop/items/spawn_egg_3.png)

Check out [Adding the Item to a Creative Tab](./first-item#adding-the-item-to-a-creative-tabs) for more detailed information.
