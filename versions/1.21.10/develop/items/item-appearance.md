...
@[code lang=java transcludeWith=:::item](@/reference/1.21.10/src/main/java/com/example/docs/appearance/ExampleModAppearance.java)
...
@[code lang=java transcludeWith=:::tint_source](@/reference/1.21.10/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transclude={17-20}](@/reference/1.21.10/src/client/java/com/example/docs/appearance/RainTintSource.java)

We can then return this Codec in `type()`.

@[code lang=java transclude={35-38}](@/reference/1.21.10/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transclude={26-33}](@/reference/1.21.10/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transcludeWith=:::item_tint_source](@/reference/1.21.10/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)

Once this is done, we can use our item tint source in a client item definition.

@[code lang=json transclude](@/reference/1.21.10/src/main/generated/assets/example-mod/items/waxcap.json)
