...
@[code lang=java transcludeWith=:::problems:basic-logger-definition](@/reference/1.21.10/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:using-logger](@/reference/1.21.10/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=java transcludeWith=:::problems:logger-usage-example](@/reference/1.21.10/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=java transcludeWith=:::problems:dev-logger](@/reference/1.21.10/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:breakpoints](@/reference/1.21.10/src/main/java/com/example/docs/debug/TestItem.java)
