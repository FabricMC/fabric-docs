...
@[code lang=java transcludeWith=:::block](@/reference/1.21.10/src/main/java/com/example/docs/appearance/ExampleModAppearance.java)
...
@[code lang=java transcludeWith=:::block_render_layer_map](@/reference/1.21.10/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)
...
@[code lang=java transcludeWith=:::color_provider](@/reference/1.21.10/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)
