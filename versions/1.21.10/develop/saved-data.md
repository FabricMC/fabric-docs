...
@[code lang=java transcludeWith=:::basic_structure](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)
...
@[code lang=java transcludeWith=:::ctor](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)

Then we can build a Codec.

@[code lang=java transcludeWith=:::codec](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)

We should call `setDirty()` when data is actually modified, so Minecraft knows it should be saved to the disk.

@[code lang=java transcludeWith=:::set_dirty](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)
...
@[code lang=java transcludeWith=:::type](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)
...
@[code lang=java transcludeWith=:::method](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/SavedBlockData.java)
...
@[code lang=java transcludeWith=:::event_registration](@/reference/1.21.10/src/main/java/com/example/docs/saveddata/ExampleModSavedData.java)
