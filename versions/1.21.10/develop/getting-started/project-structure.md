...
@[code lang=json](@/reference/1.21.10/src/main/resources/fabric.mod.json)
:::
...
@[code lang=java transcludeWith=#entrypoint](@/reference/1.21.10/src/main/java/com/example/docs/ExampleMod.java)
