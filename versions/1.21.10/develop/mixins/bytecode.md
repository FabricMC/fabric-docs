...
However, Minecraft 1.21.10 does not provide that by default and is therefore said to be obfuscated. Note that [future versions of Minecraft will be deobfuscated](../porting/mappings/#whats-going-on-with-mappings).
:::
