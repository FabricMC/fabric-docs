...
@[code transcludeWith=:::automatic-testing:2](@/reference/1.21.10/build.gradle)
...
@[code transcludeWith=:::automatic-testing:game-test:1](@/reference/1.21.10/build.gradle)
...
@[code transcludeWith=:::automatic-testing:game-test:2](@/reference/1.21.10/build.gradle)
