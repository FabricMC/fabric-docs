...
@[code lang=groovy transcludeWith=:::automatic-testing:2](@/reference/1.21.10/build.gradle)
...
@[code lang=java transcludeWith=:::automatic-testing:4](@/reference/1.21.10/src/test/java/com/example/docs/codec/BeanTypeTest.java)
...
@[code lang=log transcludeWith=:::automatic-testing:5](@/reference/1.21.10/src/test/java/com/example/docs/codec/BeanTypeTest.java)
...
@[code lang=java transcludeWith=:::automatic-testing:7](@/reference/1.21.10/src/test/java/com/example/docs/codec/BeanTypeTest.java)
...
@[code lang=groovy transcludeWith=:::automatic-testing:game-test:1](@/reference/1.21.10/build.gradle)
...
<<< @/reference/1.21.10/src/gametest/resources/fabric.mod.json
...
<<< @/reference/1.21.10/src/gametest/java/com/example/docs/ExampleModGameTest.java [Server]

<<< @/reference/1.21.10/src/gametest/java/com/example/docs/ExampleModClientGameTest.java [Client]
...
@[code lang=groovy transcludeWith=:::automatic-testing:game-test:2](@/reference/1.21.10/build.gradle)
