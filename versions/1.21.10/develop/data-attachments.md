...
@[code lang=java transcludeWith=:::string](@/reference/1.21.10/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::pos](@/reference/1.21.10/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::persistent](@/reference/1.21.10/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::stamina](@/reference/1.21.10/src/main/java/com/example/docs/attachment/Stamina.java)
