...
```java
// Create a codec for a map of resourcelocations to integers
...
Take for example vanilla `ResourceLocation`s. While all resourcelocations can be turned into strings, not all strings are valid resourcelocations,
