...
@[code lang=java transcludeWith=:::provider](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::cube-all](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/block/steel_block.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/blockstates/steel_block.json)
...
@[code lang=java transcludeWith=:::cube-top-for-ends](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/block/pipe_block.json)
...
@[code lang=java transcludeWith=:::block-texture-pool-normal](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::family-declaration](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)

@[code lang=java transcludeWith=:::block-texture-pool-family](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::door-and-trapdoor](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code transcludeWith=:::custom-blockstate-model-generator](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::custom-voxels](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)

@[code lang=java transcludeWith=:::custom-collision](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)

Also override the `canReplace()` method, otherwise you couldn't make the slab a full block.

@[code lang=java transcludeWith=:::custom-replace](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)
...
@[code lang=json](@/reference/1.21.10/src/main/resources/assets/example-mod/models/block/vertical_slab.json)
...
@[code lang=java transcludeWith=:::custom-model](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::custom-texture-map](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::custom-supplier](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::custom-gen](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::custom-method-call](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
