...
@[code lang=java transcludeWith=:::datagen-setup:generator](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-setup:pack](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
