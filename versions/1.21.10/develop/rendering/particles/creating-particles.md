...
@[code lang=java transcludeWith=#particle_register_main](@/reference/1.21.10/src/main/java/com/example/docs/ExampleMod.java)
...
@[code lang=java transcludeWith=#particle_register_client](@/reference/1.21.10/src/client/java/com/example/docs/ExampleModClient.java)
...
@[code lang=json](@/reference/1.21.10/src/main/resources/assets/example-mod/particles/sparkle_particle.json)
