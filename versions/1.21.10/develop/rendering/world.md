...
@[code lang=java transcludeWith=:::custom-pipelines:define-pipeline](@/reference/1.21.10/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:extraction-phase](@/reference/1.21.10/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:drawing-phase](@/reference/1.21.10/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:clean-up](@/reference/1.21.10/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
@[code lang=java](@/reference/1.21.10/src/client/java/com/example/docs/mixin/client/GameRendererMixin.java)

### Final Code {#final-code}

Combining all the steps from above, we get a simple class that renders a waypoint at `(0, 100, 0)` through walls.

@[code lang=java](@/reference/1.21.10/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
