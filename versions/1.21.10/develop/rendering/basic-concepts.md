...
@[code lang=java transcludeWith=:::registration](@/reference/1.21.10/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)

**Implementation of `hudLayer()`:**

@[code lang=java transcludeWith=:::hudLayer](@/reference/1.21.10/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)
