...
@[code transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
Метод регистрации принимает экземпляр класса `Item.Properties` в качестве параметра. Этот класс позволяет вам настраивать свойства предмета через различные методы.
...
`Item::new` говорит функции регистрации создать экземпляр `Item` из `Item.Properties`, вызывая конструктор `Item` (`new Item(...)`), принимающий `Item.Properties` в качестве параметра.
...
@[code transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)

@[code transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/item/ExampleModItems.java)
...
:::info
Если вы хотите добавить предмет в собственную `CreativeModeTab`, ознакомьтесь со страницей [Собственные группы предмета](./custom-item-groups) для получения дополнительной информации.
:::

Для примера мы добавим этот элемент в `CreativeModeTab` "ингредиенты", вам нужно будет использовать события групп предметов из Fabric API, а именно `ItemGroupEvents.modifyEntriesEvent`

Это может быть сделано в методе `initialize` вашего класса.

@[code transcludeWith=:::4](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/item/suspicious_substance.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/items/suspicious_substance.json)
...
@[code transcludeWith=:::_10](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::_11](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
...
Если вы хотите, чтобы у вашего элемента была настраиваемая подсказка, вам нужно будет создать класс, расширяющий `Item`, и переопределить метод `appendHoverText`.
...
@[code lang=java transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/LightningStick.java)
