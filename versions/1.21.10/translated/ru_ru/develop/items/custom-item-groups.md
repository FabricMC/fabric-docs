...
Если при создании группы предметов вы передали`Component.translatable` в метод `displayName`, вам необходимо добавить перевод названия вкладки в свой файл перевода.
