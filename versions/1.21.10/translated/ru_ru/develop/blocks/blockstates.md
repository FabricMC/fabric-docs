...
@[code transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/block/condensed_oak_log_horizontal.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/blockstates/condensed_oak_log.json)
...
@[code transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code transcludeWith=:::4](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/blockstates/prismarine_lamp.json)
...
@[code transcludeWith=:::5](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)

@[code transcludeWith=:::4](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)
