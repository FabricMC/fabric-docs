...
:::info
Якщо ви хочете додати предмет до спеціальної `CreativeModeTab`, перегляньте сторінку [власні групи предметів](./custom-item-groups) для отримання додаткової інформації.
:::

Для прикладу ми додамо цей предмет до інгредієнтів `CreativeModeTab`, вам потрібно буде використовувати події групи предметів Fabric API, зокрема `ItemGroupEvents.modifyEntriesEvent`
...
Якщо ви хочете, щоб ваш предмет мав спеціальну підказку, вам потрібно буде створити клас, який розширює `Item` і перевизначає метод `appendHoverText`.
