...
`Font` має методи для вимірювання тексту (`width`), що корисно для центрування, і для його малювання (`drawInBatch`).
...
Метод `drawInBatch` приймає багато параметрів, але найважливіші з них:
