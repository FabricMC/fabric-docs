...
Подібно до предметів, блоки приймають клас `BlockBehaviour.Properties` у своєму конструкторі, який визначає властивості блоку, такі як його звукові ефекти та рівень видобутку.
...
:::tip
Ви також можете використовувати `BlockBehaviour.Properties.ofFullCopy(AbstractBlock block)`, щоб скопіювати налаштування блоку що існує, у цьому випадку ми могли б використати `Blocks.DIRT`, щоб скопіювати налаштування dirt, але для прикладу ми скористаємося конструктором.
:::
