...
@[code lang=java transcludeWith=:::datagen-model:provider](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model:cube-all](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model:cube-top-for-ends](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model:block-texture-pool-normal](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model:family-declaration](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)

@[code lang=java transcludeWith=:::datagen-model:block-texture-pool-family](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model:door-and-trapdoor](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model-custom:voxels](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)

@[code lang=java transcludeWith=:::datagen-model-custom:collision](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)

Також замініть метод `canReplace()`, інакше ви не зможете зробити плиту повним блоком.

@[code lang=java transcludeWith=:::datagen-model-custom:replace](@/reference/1.21.10/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java)
...
@[code lang=java transcludeWith=:::datagen-model-custom:model](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model-custom:texture-map](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model-custom:supplier](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code lang=java transcludeWith=:::datagen-model-custom:method-call](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
