...
### Розширення `MobEffect` {#extend-statuseffect}
...
реєстрі `MOB_EFFECT`. Це можна зробити в нашому ініціалізаторі.
...
| Аргумент    | Тип                           | Опис                                                                                                                                                                                                                                                                 |
| ----------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `effect`    | `Holder<MobEffect>` | Запис реєстру, який представляє ефект.                                                                                                                                                                                                               |
