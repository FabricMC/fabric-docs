...
Якщо у вас виникли проблеми, повідомте про них [на GitHub](https://github.com/FabricMC/fabric-docs) або зверніться по допомогу в [Discord Fabric](https://discord.gg/v6v4pMv) у канали `#player-support` або `#mc-server-support`.
