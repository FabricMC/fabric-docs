...
@[code lang=java highlight={3} transcludeWith=:::4](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={3,13} transcludeWith=:::5](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java transcludeWith=:::11](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java transcludeWith=:::10 highlight={3}](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
