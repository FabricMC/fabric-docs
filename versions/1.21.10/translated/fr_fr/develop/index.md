...
Et rappelez-vous : un mod totalement opérationnel contenant tout le code de cette documentation est disponible dans [le dossier `/reference` sur GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/1.21.10).
