...
@[code lang=java transcludeWith=:::summon_Lightning_payload](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/SummonLightningS2CPayload.java)

Zugleich haben wir folgendes definiert:

- Einen `ResourceLocation`, der zur Identifizierung des Payload unseres Pakets verwendet wird. In diesem Beispiel lautet der Bezeichner `example-mod:summon_lightning`.
...
@[code lang=java transclude={14-14}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/SummonLightningS2CPayload.java)
...
@[code lang=java transclude={15-15}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/SummonLightningS2CPayload.java)

Wir haben auch `getId` überschrieben, um unsere Payload-ID zurückzugeben.

@[code lang=java transclude={17-20}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/SummonLightningS2CPayload.java)
...
@[code lang=java transclude={25-25}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transcludeWith=:::lightning_tater_item](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)
...
@[code lang=java transclude={22-24}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)

Wir erstellen eine Instanz des Payloads mit der Position des Users:

@[code lang=java transclude={26-26}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)

Schließlich rufen wir die Spieler in der Serverwelt durch `PlayerLookup` ab und senden ein Paket an jeden Spieler.

@[code lang=java transclude={28-30}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)
...
@[code lang=java transcludeWith=:::client_global_receiver](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transclude={32-32}](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)

Schließlich erstellen wir eine `LightningEntity` und fügen sie der Welt hinzu.

@[code lang=java transclude={33-38}](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transcludeWith=:::give_glowing_effect_payload](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/GiveGlowingEffectC2SPayload.java)
...
@[code lang=java transclude={26-26}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transcludeWith=:::use_entity_callback](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transclude={51-51}](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transclude={52-52}](@/reference/1.21.10/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transcludeWith=:::server_global_receiver](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transclude={30-30}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transclude={32-32}](@/reference/1.21.10/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
:::
