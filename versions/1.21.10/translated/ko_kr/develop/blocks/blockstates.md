...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/models/block/condensed_oak_log_horizontal.json)
...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/blockstates/condensed_oak_log.json)
