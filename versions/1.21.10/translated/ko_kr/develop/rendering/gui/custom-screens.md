...
@[code lang=java transcludeWith=:::1](@/reference/1.21.10/src/client/java/com/example/docs/rendering/screens/CustomScreen.java)
...
@[code lang=java transcludeWith=:::2](@/reference/1.21.10/src/client/java/com/example/docs/rendering/screens/CustomScreen.java)
