...
@[code lang=json](@/reference/1.21.10/src/main/generated/data/example-mod/damage_type/tater.json)
...
Cuando necesitamos acceder nuestro tipo de daño en el código, necesitaremos usar su `ResourceKey` (Llave de Registro) para crear una instancia de `DamageSource` (Fuente de Daño).

El `ResourceKey` puede ser obtenida de la siguiente manera:

@[code lang=java transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/damage/ExampleModDamageTypes.java)
...
@[code lang=java transclude={21-24}](@/reference/1.21.10/src/main/java/com/example/docs/damage/TaterBlock.java)

Después, llamamos `entity.hurt()` con nuestro `DamageSource` y una cantidad.

@[code lang=java transclude={25-25}](@/reference/1.21.10/src/main/java/com/example/docs/damage/TaterBlock.java)

La implementación del bloque completa:

@[code lang=java transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/damage/TaterBlock.java)
...
@[code lang=json transclude={4-4}](@/reference/1.21.10/src/main/resources/assets/example-mod/lang/en_us.json)
...
@[code lang=json](@/reference/1.21.10/src/main/generated/data/minecraft/tags/damage_type/bypasses_armor.json)
