...
@[code lang=java highlight={2} transcludeWith=:::2](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={3} transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={3} transcludeWith=:::7](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={2,8} transcludeWith=:::8](@/reference/1.21.10/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java transcludeWith=:::12](@/reference/1.21.10/src/client/java/com/example/docs/client/command/ExampleModClientCommands.java)
