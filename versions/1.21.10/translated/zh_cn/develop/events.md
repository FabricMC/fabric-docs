...
@[code lang=java transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transclude={38-40}](@/reference/1.21.10/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code highlight={6-7} transcludeWith=:::2](@/reference/1.21.10/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transcludeWith=:::](@/reference/1.21.10/src/main/java/com/example/docs/event/SheepShearCallback.java)

让我们更深入地看看。 当 invoker 被调用时，我们将遍历所有监听器：

@[code lang=java transclude={21-22}](@/reference/1.21.10/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transcludeWith=:::](@/reference/1.21.10/src/main/java/com/example/docs/mixin/event/SheepEntityMixin.java)
...
@[code lang=java transcludeWith=:::3](@/reference/1.21.10/src/main/java/com/example/docs/event/ExampleModEvents.java)
