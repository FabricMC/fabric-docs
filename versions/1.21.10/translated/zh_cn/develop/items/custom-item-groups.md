...
@[code transcludeWith=:::9](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)

@[code transcludeWith=:::_12](@/reference/1.21.10/src/main/java/com/example/docs/item/ModItems.java)
