...
```md
<<< @/reference/1.21.10/src/main/java/com/example/docs/ExampleMod.java{15-21}
```

<<< @/reference/1.21.10/src/main/java/com/example/docs/ExampleMod.java{15-21}[java]
...
```md
@[code transcludeWith=#entrypoint](@/reference/1.21.10/src/main/java/com/example/docs/ExampleMod.java)
```
