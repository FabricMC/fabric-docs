...
@[code lang=java transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/CustomSoundItem.java)
...
@[code lang=java transcludeWith=:::2](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/CustomSoundItem.java)
...
Minecraft ha vari slider audio nelle impostazioni del gioco. L'enum `SoundSource` è usato per determinare quale slider controllerà il volume del tuo suono.
