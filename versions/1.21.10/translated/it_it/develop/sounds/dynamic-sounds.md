...
Ma quando quei valori vengono inviati tramite rete, potresti voler definire un `ResourceLocation` per esse o anche aggiungere altri valori personalizzati.
