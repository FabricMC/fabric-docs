...
@[code lang=java transcludeWith=:::datagen-recipes:provider](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transclude={32-32}](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:shapeless](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:shaped](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:other](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
