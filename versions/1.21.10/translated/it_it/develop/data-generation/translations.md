...
@[code lang=java transcludeWith=:::datagen-translations:provider](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java)
...
@[code lang=java transclude={28-28}](@/reference/1.21.10/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
