...
@[code transcludeWith=::1](@/reference/1.21.10/src/main/java/com/example/docs/component/ModComponents.java)
...
@[code transcludeWith=::2](@/reference/1.21.10/src/main/java/com/example/docs/component/ModComponents.java)
...
@[code transcludeWith=::1](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::3](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::2](@/reference/1.21.10/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::1](@/reference/1.21.10/src/main/java/com/example/docs/component/MyCustomComponent.java)
...
@[code transcludeWith=::2](@/reference/1.21.10/src/main/java/com/example/docs/component/MyCustomComponent.java)
...
@[code transcludeWith=::3](@/reference/1.21.10/src/main/java/com/example/docs/component/ModComponents.java)
