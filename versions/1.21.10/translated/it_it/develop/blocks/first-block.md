...
@[code transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code transcludeWith=:::1](@/reference/1.21.10/src/main/java/com/example/docs/block/ExampleModBlocks.java)

## Creare e Registrare il Tuo Blocco {#creating-and-registering-your-block}

In maniera del tutto simile agli oggetti, i blocchi accettano delle `BlockBehaviour.Properties` nel costruttore. La classe indica proprietà specifiche del blocco, come i suoi effetti sonori e il livello di estrazione.
...
@[code transcludeWith=:::2](@/reference/1.21.10/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/models/block/condensed_dirt.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/items/condensed_dirt.json)
...
@[code](@/reference/1.21.10/src/main/generated/assets/example-mod/blockstates/condensed_dirt.json)
...
@[code](@/reference/1.21.10/src/main/resources/data/example-mod/loot_tables/blocks/condensed_dirt.json)
