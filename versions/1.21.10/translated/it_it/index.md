...
features:
  ...
  - title: Guide per Sviluppatori
    ...
    link: /it_it/1.21.10/develop/
    linkText: Per Iniziare
---

::: warning
Stai attualmente visualizzando la documentazione per Minecraft 1.21.10. Se cerchi un'altra versione, per favore selezionala dal menu a tendina nella barra di navigazione.
:::
