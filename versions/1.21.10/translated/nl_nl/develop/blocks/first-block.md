...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/models/item/condensed_dirt.json)

Het blokmodel moet in ons geval echter als ouder het `block/cube_all`-model hebben:

@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/models/block/condensed_dirt.json)
...
@[code](@/reference/1.21.10/src/main/resources/assets/example-mod/blockstates/condensed_dirt.json)
