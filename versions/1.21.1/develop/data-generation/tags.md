...
@[code lang=java transclude={28-28}](@/reference/1.21.1/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)

## Creating a Tag {#creating-a-tag}

Now that you've created a provider, let's add a tag to it. First, create a `TagKey<T>`:

@[code lang=java transcludeWith=:::datagen-tags:tag-key](@/reference/1.21.1/src/client/java/com/example/docs/datagen/ExampleModItemTagProvider.java)
...
@[code lang=java transcludeWith=:::datagen-tags:build](@/reference/1.21.1/src/client/java/com/example/docs/datagen/ExampleModItemTagProvider.java)
