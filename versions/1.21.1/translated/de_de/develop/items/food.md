...
description: Lerne, wie man einen FoodProperties zu einem Item hinzufügt, um es essbar zu machen, und wie man es konfiguriert.
authors:
  - IMB11
---
...
Um einen Nahrungsmittel Component zu einem Item hinzuzufügen, können wir es an die `Item.Properties` Instanz übergeben:
...
Die Klasse `FoodProperties.Builder` hat viele Methoden, mit denen du ändern kannst, was passiert, wenn ein Spieler dein Item isst:
...
| `fast`              | Deklariert dein Item als Snack.                                                                                                                                                                                                    |
| `effect`       | Fügt einen Statuseffekt hinzu, wenn du dein Item isst. Normalerweise wird dieser Methode eine Instanz des Statuseffekts und eine Chance übergeben, wobei die Chance ein dezimaler Prozentsatz ist (`1f = 100%`) |
