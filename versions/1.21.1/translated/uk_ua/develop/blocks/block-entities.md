...
- створити блок, який розширює `BaseEntityBlock`, і реалізувати метод `newBlockEntity` (_і_ метод `getRenderType`, оскільки `BaseEntityBlock` робить його невидимим за замовчуванням)
