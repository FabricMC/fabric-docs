...
Используя наш пример выше, мы можем масштабировать наш алмаз вверх и вниз, используя `PoseStack` и `tickDelta`, то есть время, прошедшее с момента последнего кадра.
