...
@[code lang=java transcludeWith=:::test_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={2} transcludeWith=:::dedicated_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
@[code lang=java transcludeWith=:::execute_dedicated_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={3} transcludeWith=:::required_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
@[code lang=java transcludeWith=:::execute_required_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={3} transcludeWith=:::sub_command_one](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
@[code lang=java transcludeWith=:::execute_sub_command_one](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java highlight={2,8} transcludeWith=:::sub_command_two](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
@[code lang=java transcludeWith=:::execute_command_sub_command_two](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
...
@[code lang=java transcludeWith=:::1](@/reference/1.21.1/src/client/java/com/example/docs/client/command/ExampleModClientCommands.java)
...
@[code lang=java transcludeWith=:::redirect_command](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
@[code lang=java transcludeWith=:::execute_redirected_by](@/reference/1.21.1/src/main/java/com/example/docs/command/ExampleModCommands.java)
