...
@[code lang=json](@/reference/1.20.4/src/main/generated/data/example-mod/damage_type/tater.json)
...
@[code lang=json transclude={4-4}](@/reference/1.20.4/src/main/resources/assets/example-mod/lang/en_us.json)
