...
@[code lang=java transcludeWith=:::1](@/reference/1.20.4/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transclude={38-40}](@/reference/1.20.4/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code highlight={6-7} transcludeWith=:::2](@/reference/1.20.4/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transcludeWith=:::3](@/reference/1.20.4/src/main/java/com/example/docs/event/ExampleModEvents.java)
