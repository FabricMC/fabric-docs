...
Si vous rencontrez de quelconques problèmes avec la documentation, demandez de l'aide sur le [Discord de Fabric](https://discord.gg/v6v4pMv) dans les canaux `#player-support` or `#mc-server-support`, ou signalez-les [sur GitHub](https://github.com/FabricMC/fabric-docs).
