---
title: 食物物品
description: 学会如何给物品添加 FoodProperties 以让它可食物，并配置。
authors:
  - IMB11
...
`FoodProperties` 类有很多方法，允许你修改玩家吃你的物品时发生的事情：
...
| `fast`              | 将你的物品描述为零食。                                              |
| `effect`       | 吃你的物品时添加状态效果。 通常传递到此方法的是一个状态效果实例和概率，其中概率是小数（`1f = 100%`） |

按照自己的喜欢修改了 builder 后，可以调用 `build()` 方法以获得 `FoodProperties`
