...
- `GuiEventListener` - per eventi - Necessario se vuoi gestire gli eventi come click del mouse, pressione di tasti, e altro.
...
Puoi gestire eventi come click del mouse, pressione di tasti, facendo override dei metodi `mouseClicked`, `afterMouseAction`, `keyPressed`, e altri.
