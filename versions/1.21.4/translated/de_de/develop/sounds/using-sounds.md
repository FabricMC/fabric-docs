...
@[code lang=java transcludeWith=:::1](@/reference/1.21.4/src/main/java/com/example/docs/item/CustomSoundItem.java)
...
@[code lang=java transcludeWith=:::2](@/reference/1.21.4/src/main/java/com/example/docs/item/CustomSoundItem.java)
