...
Коли ви зміните конструктор на свій _смак_, ви можете викликати метод `build()`, щоб отримати `FoodProperties`.

Якщо ви хочете додати ефекти для гравця, коли він їсть вашу їжу, вам потрібно буде використовувати `ConsumableComponent` разом з класом `FoodProperties`, як показано в наступному прикладі:
