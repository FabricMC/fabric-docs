...
If you want to add mob effects to the player when they eat your food, you will need to use the `ConsumableComponent` alongside the `FoodProperties` class as seen in the following example:
