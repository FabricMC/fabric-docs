...
@[code lang=java transcludeWith=:::register](@/reference/1.21.11/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)
...
@[code lang=java transcludeWith=:::attributes](@/reference/1.21.11/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)
...
@[code lang=java transcludeWith=:::initialize](@/reference/1.21.11/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)

@[code lang=java transcludeWith=:::init](@/reference/1.21.11/src/main/java/com/example/docs/entity/attribute/ExampleModAttributes.java)
