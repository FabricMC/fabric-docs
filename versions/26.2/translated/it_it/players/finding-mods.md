...
La maggior parte degli autori pubblica le loro mod su [Modrinth](https://modrinth.com/mods?g=categories:%27fabric%27) e [CurseForge](https://www.curseforge.com/minecraft/search?class=mc-mods&gameVersionTypeId=4).
...
Se hai dubbi, sentiti libero di chiedere nel [Discord di Fabric](https://discord.fabricmc.net/) nel canale `#player-support`.

## 3. Evita Siti Comuni Maligni! {#avoid-malware}

::: info

Il fatto che un sito sia maligno potrebbe non essere ovvio per tutti. Se non sei sicuro, dovresti chiedere l'opinione di altri o evitare il sito completamente e affidarti solo a fonti fidate, come Modrinth e CurseForge.
...
Puoi usare software antivirus e siti come [Windows Defender](https://www.microsoft.com/it-it/windows/comprehensive-security) o [VirusTotal](https://www.virustotal.com/) per controllare le mod scaricate. Tuttavia, non affidarti completamente a quei metodi, perché a volte potrebbero essere errati.

Ancora, se hai dubbi, sentiti libero di chiedere l'opinione di altri nel [Discord di Fabric](https://discord.fabricmc.net/) nel canale `#player-support`.
