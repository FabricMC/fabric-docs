...
<<< @/reference/26.2/src/main/generated/data/example-mod/damage_type/tater.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/damage/ExampleModDamageTypes.java#damage_type
...
Puoi fare override di `stepOn` per infliggere questo danno.

Cominciamo creando una `DamageSource` del nostro tipo di danno personalizzato.

<<< @/reference/26.2/src/main/java/com/example/docs/damage/TaterBlock.java#create_damage_source

Poi, chiamiamo `entity.hurtServer()` con il livello attuale, la nostra `DamageSource`, e con una quantità.

<<< @/reference/26.2/src/main/java/com/example/docs/damage/TaterBlock.java#hurt_entity

L'intera implementazione del blocco:

<<< @/reference/26.2/src/main/java/com/example/docs/damage/TaterBlock.java#complete_block
...
Alcuni tipi di danno possono bypassare armatura, bypassare effetti dei mob, o simili. I tag sono usati per controllare questo genere di proprietà dei tipi di danno.
...
<<< @/reference/26.2/src/main/generated/data/minecraft/tags/damage_type/bypasses_armor.json
