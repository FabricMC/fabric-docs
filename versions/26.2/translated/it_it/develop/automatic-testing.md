...
<<< @/reference/26.2/build.gradle#automatic_testing_2
...
<<< @/reference/26.2/src/test/java/com/example/docs/codec/BeanTypeTest.java#automatic_testing_4
...
<<< @/reference/26.2/src/test/java/com/example/docs/codec/BeanTypeTest.java#automatic_testing_7
...
<<< @/reference/26.2/build.gradle#automatic_testing_game_test_1
...
<<< @/reference/26.2/src/gametest/resources/fabric.mod.json
...
<<< @/reference/26.2/src/gametest/java/com/example/docs/ExampleModGameTest.java[Server]

<<< @/reference/26.2/src/gametest/java/com/example/docs/ExampleModClientGameTest.java[Client]
...
<<< @/reference/26.2/build.gradle#automatic_testing_game_test_2
