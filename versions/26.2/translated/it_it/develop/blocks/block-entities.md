...
@[code transcludeWith=:::1](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)

La registrazione di un `BlockEntity` produce un `BlockEntityType` come il `COUNTER_BLOCK_ENTITY` che abbiamo usato sopra:

@[code transcludeWith=:::1](@/reference/26.2/src/main/java/com/example/docs/block/entity/ModBlockEntities.java)
...
- creare un blocco che estenda `BaseEntityBlock` e implementi il metodo `createBlockEntity`
- creare un blocco che implementi `EntityBlock` per sé e faccia override del metodo `createBlockEntity`

Useremo il primo approccio in questo esempio, poiché `BaseEntityBlock` fornisce anche alcune utilità comode.

:::

@[code transcludeWith=:::1](@/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java)
...
@[code transcludeWith=:::5](@/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code transcludeWith=:::2](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
...
@[code transcludeWith=:::2](@/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java)
...
@[code transcludeWith=:::3](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
...
@[code transcludeWith=:::4](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
...
@[code transcludeWith=:::7](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
...
@[code transcludeWith=:::3](@/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java)
...
@[code transcludeWith=:::5](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
...
@[code transcludeWith=:::6](@/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java)
