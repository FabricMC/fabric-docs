...
@[code lang=java transcludeWith=:::datagen-recipes:provider](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:register](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:shapeless](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:shaped](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:other](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
