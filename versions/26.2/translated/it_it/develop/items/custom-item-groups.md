...
@[code transcludeWith=:::9](@/reference/26.2/src/main/java/com/example/docs/item/ModItems.java)

@[code transcludeWith=:::\_12](@/reference/26.2/src/main/java/com/example/docs/item/ModItems.java)
