...
@[code transcludeWith=#entrypoint](@/reference/26.2/src/main/java/com/example/docs/enchantment/effect/LightningEnchantmentEffect.java)
...
@[code transcludeWith=#entrypoint](@/reference/26.2/src/main/java/com/example/docs/enchantment/ModEnchantmentEffects.java)
...
@[code transcludeWith=#entrypoint](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModEnchantmentGenerator.java)
...
@[code transcludeWith=:::custom-enchantments:register-generator](@/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code](@/reference/26.2/src/main/generated/data/example-mod/enchantment/thundering.json)
