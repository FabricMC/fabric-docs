---
title: Loomのオプション
description: Fabric Loom Gradleプラグインの全てのオプションの仕様書。
authors:
  - Atakku
  - caoimhebyrne
  - Daomephsta
...
このページには、「loom」というGradle 拡張機能に含まれる、全てのオプションに関する仕様が記載されています。 Fabric API固有の機能に関するオプションについては、[Fabric API DSL](./fabric-api)のページをご覧ください。
