...
<<< @/reference/26.2/src/main/java/com/example/docs/command/ExampleModCommands.java#command_with_suggestions{4}

<<< @/reference/26.2/src/main/java/com/example/docs/command/ExampleModCommands.java#execute_command_with_suggestions
...
<<< @/reference/26.2/src/main/java/com/example/docs/command/PlayerSuggestionProvider.java#suggestion_provider

要使用這個建議提供器，只需將一個實例傳遞到參數構造器的 `.suggests` 方法。

<<< @/reference/26.2/src/main/java/com/example/docs/command/ExampleModCommands.java#command_with_custom_suggestions{4}

<<< @/reference/26.2/src/main/java/com/example/docs/command/ExampleModCommands.java#execute_command_with_custom_suggestions
