...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java#datagen_translations_provider
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java#datagen_translations_register
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java#datagen_translations_build
