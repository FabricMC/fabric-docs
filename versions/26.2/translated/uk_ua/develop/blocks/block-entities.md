...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#block_entity

Реєстрація `BlockEntity` дає `BlockEntityType`, подібний до `COUNTER_BLOCK_ENTITY`, який ми використовували вище:

<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/ModBlockEntities.java#register_block_entity
...
Якби ми не жорстко закодували `BlockEntityType`, клас `ModBlockEntities` не компілювався б! Це пояснюється тим, що `FabricBlockEntityTypeBuilder.Factory` — функціональний інтерфейс, який описує функцію, що приймає лише два параметри, так само як і наш конструктор.
...
- створити блок, який сам собою реалізує `EntityBlock` і замінити метод `newBlockEntity`

У цьому прикладі ми використаємо перший підхід, оскільки `BaseEntityBlock` також надає кілька крутих штук.

:::

<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java#block
...
На відміну від блоків, які є синглетонами, нова блок-сутність створюється для кожного екземпляра блока. Це робиться за допомогою методу `newBlockEntity`, який приймає позицію та `BlockState` і повертає `BlockEntity` або `null`, якщо його не має бути.
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/ModBlockItemIds.java#counter_block

<<< @/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java#counter_block
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#clicks
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java#use
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#saving
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#loading
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#get_update_tag
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#update_packet

Потім перевизначте `setChanged`, щоб надсилати дані щоразу, коли змінюється блок-сутність.

<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#broadcast_update
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/CounterBlock.java#tickers
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#tickers
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/entity/custom/CounterBlockEntity.java#ticks_since_last
