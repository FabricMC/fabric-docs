...
Щоб побачити додані записи переліку у декомпільованому початковому коді, необхідно оновити проєкт Gradle і [повторно згенерувати початковий код](../getting-started/generating-sources).
