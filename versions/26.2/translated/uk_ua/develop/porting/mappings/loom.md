...
По-перше, вам потрібно запустити команду `migrateMappings`, яка перетворить ваші поточні мапінги на мапінги Yarn. Це можна знайти на [сайті розробки](https://fabricmc.net/develop) під «Mappings Migration». Наприклад:
