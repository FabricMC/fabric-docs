...
authors:
  ...
  - deirn
resources:
  https://plugins.jetbrains.com/plugin/28938-ravel-remapper: Плаґін Ravel — JB Marketplace
  https://github.com/badasintended/ravel: Вихідний код Ravel
---

[Ravel](https://github.com/badasintended/ravel) — це плаґін для IntelliJ IDEA для переналаштування вихідних файлів на основі [PSI IntelliJ](https://plugins.jetbrains.com/docs/intellij/psi.html) і [Mapping-IO](https://github.com/FabricMC/mapping-io). Він підтримує перемапування Java, Kotlin, міксинів (написані на Java), твікери класу і розширювачі доступу.

Установіть його з [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/28938-ravel-remapper) або завантажте ZIP-файл з [випусків GitHub](https://github.com/badasintended/ravel/releases) і встановіть його, натиснувши значок шестірні в налаштуваннях плаґіна та натиснувши **Install Plugin From Disk**.
...
Потім натисніть **OK** і дочекайтеся завершення перемапування.

### Оновлення Gradle {#updating-gradle}

Після завершення перемапування замініть свої мапінги в `build.gradle` вашого мода.
...
Ось і основна частина роботи виконана! Тепер ви захочете переглянути вихідний код, щоб перевірити потенційно застарілі цілі міксина або код, який не було перемаповано.
