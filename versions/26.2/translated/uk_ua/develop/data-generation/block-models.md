...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#cube_all
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/models/block/steel_block.json
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/blockstates/steel_block.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#cube_top_for_ends
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/models/block/pipe_block.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#block_texture_pool_normal
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java#family_declaration

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#block_texture_pool_family
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#door_and_trapdoor
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_blockstate_model_generator
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java#custom_voxels

<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java#custom_collision

Також замініть метод `canReplace()`, інакше ви не зможете зробити плиту повним блоком.

<<< @/reference/26.2/src/main/java/com/example/docs/block/custom/VerticalSlabBlock.java#custom_replace
...
<<< @/reference/26.2/src/main/resources/assets/example-mod/models/block/vertical_slab.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_model
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_texture_map
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_supplier
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_gen
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_method_call
