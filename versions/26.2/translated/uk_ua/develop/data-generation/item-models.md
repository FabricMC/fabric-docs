...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#provider

Зареєструйте цей клас у своїй `DataGeneratorEntrypoint` в рамках методу `onInitializeDataGenerator`.

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java#datagen_models_register
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#generated

== Клієнтський предмет

`generated/assets/example-mod/items/ruby.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/ruby.json

== Модель предмета

`generated/assets/example-mod/models/item/ruby.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/ruby.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#handheld

== Клієнтський предмет

`generated/assets/example-mod/items/guidite_axe.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/guidite_axe.json

== Модель предмета

`generated/assets/example-mod/models/item/guidite_axe.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/guidite_axe.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#dyeable

:::warning ВАЖЛИВО

Ви повинні створити [`DyeRecipe`](./recipes#dye-recipes) для свого предмета, щоб мати можливість забарвити його у своєму інвентарі!
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/items/leather_gloves.json

== Модель предмета

`generated/assets/example-mod/models/item/leather_gloves.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/leather_gloves.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#condition
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/items/flashlight.json

== Моделі предмета

`generated/assets/example-mod/models/item/flashlight.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/flashlight.json

`generated/assets/example-mod/models/item/flashlight_lit.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/flashlight_lit.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#composite

== Клієнтський предмет

`generated/assets/example-mod/items/enhanced_hoe.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/enhanced_hoe.json

== Моделі предмета

`generated/assets/example-mod/models/item/enhanced_hoe.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/enhanced_hoe.json

`generated/assets/example-mod/models/item/enhanced_hoe_plus.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/enhanced_hoe_plus.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#select

== Клієнтський предмет

`generated/assets/example-mod/items/dimensional_crystal.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/dimensional_crystal.json

== Моделі предмета

`generated/assets/example-mod/models/item/dimensional_crystal_overworld.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/dimensional_crystal_overworld.json

`generated/assets/example-mod/models/item/dimensional_crystal_nether.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/dimensional_crystal_nether.json

`generated/assets/example-mod/models/item/dimensional_crystal_end.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/dimensional_crystal_end.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#range_dispatch

== Клієнтський предмет

`generated/assets/example-mod/items/throwing_knives.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/throwing_knives.json

== Моделі предмета

`generated/assets/example-mod/models/item/throwing_knives_one.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/throwing_knives_one.json

`generated/assets/example-mod/models/item/throwing_knives_two.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/throwing_knives_two.json

`generated/assets/example-mod/models/item/throwing_knives_three.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/throwing_knives_three.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_item_model_generator
...
<<< @/reference/26.2/src/main/resources/assets/example-mod/models/item/scaled2x.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_item_model
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_item_datagen_method
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#custom_balloon
