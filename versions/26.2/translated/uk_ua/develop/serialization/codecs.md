...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#encode_blockpos[Java]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/serialize_blockpos.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#parse_blockpos

### Убудовані кодеки {#built-in-codecs}
...
<<< @/reference/26.2/src/main/java/com/example/docs/codec/CoolBeansClass.java#bean_class

Відповідний файл JSON може виглядати приблизно так:

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/cool_beans.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#list_codec[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#list_codec_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/list_codec.json[Output]
...
<<< @/reference/26.2/src/main/java/com/example/docs/codec/CoolBeansClass.java#bean_codec[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#bean_codec_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/cool_beans.json[Output]
...
<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/plain_codec.json

Але після перетворення на `MapCodec<BlockPos>` за допомогою `BlockPos.CODEC.fieldOf("pos")` це виглядатиме так:

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/map_codec.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#optional_field[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#optional_field_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/optional_field.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#default_field[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#default_field_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/default_field.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#unit_codec[Codec]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/unit.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#numeric_range[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#numeric_range_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/numeric_range.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#pair_codec[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#pair_codec_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/pair.json[Output]
...
Через обмеження JSON і NBT використовуваний ключовий кодек _має_ серіалізуватися в рядок. Це включає кодеки для типів, які самі по собі не є рядками, але їх серіалізують, наприклад `Identifier.CODEC`. Дивіться приклад нижче:

::: code-group

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#map_codec[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#map_codec_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/map.json[Output]
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#convert_xmap[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#convert_xmap_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/xmap.json[Output]
...
<<< @/reference/26.2/src/main/java/com/example/docs/codec/Identifier.java#identifier_flatmap
...
| Метод          | Декодування завжди дійсне? | Кодування завжди дійсне? |
| -------------- | -------------------------- | ------------------------ |
| `xmap`         | Так                        | Так                      |
| `comapFlatMap` | Ні                         | Так                      |
| `flatComapMap` | Так                        | Ні                       |
...
`Codec#dispatch` дозволяє нам визначити реєстр кодеків і відправити до певного на основі значення в серіалізованих даних. Це дуже корисно під час десеріалізації об’єктів, які мають різні поля залежно від свого типу, але все ще представляють те саме.
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#registry_dispatch[Codec]

<<< @/reference/26.2/src/main/java/com/example/docs/codec/Bean.java#bean_interface[Bean]

<<< @/reference/26.2/src/main/java/com/example/docs/codec/BeanType.java#bean_type_record[BeanType]

<<< @/reference/26.2/src/main/java/com/example/docs/codec/StringyBean.java#stringy_bean_class[StringyBean]

<<< @/reference/26.2/src/main/java/com/example/docs/codec/CountingBean.java#counting_bean_class[CountingBean]

<<< @/reference/26.2/src/main/java/com/example/docs/codec/BeanTypes.java#bean_types_class[BeanTypes]

:::

Наш новий кодек серіалізує bean-файли в JSON таким чином, захоплюючи лише ті поля, які відповідають їх конкретному типу:

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/stringy_bean.json

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/counting_bean.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/codec/ListNode.java#node_record
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#recursive_codec[Codec]

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModCodecExampleProvider.java#recursive_codec_data[Input]

<<< @/reference/26.2/src/main/generated/reports/example-mod/codec_examples/recursive.json[Output]
