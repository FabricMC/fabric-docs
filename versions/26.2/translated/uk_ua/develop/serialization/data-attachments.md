...
Якщо вам потрібно, щоб вкладення даних було постійним і синхронізованим між сервером і клієнтами, ви можете встановити таку поведінку за допомогою методу `create`, який дозволяє налаштовувати через ланцюжок `builder`. На приклад:
