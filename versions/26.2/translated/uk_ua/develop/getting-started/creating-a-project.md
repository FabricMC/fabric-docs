...
Ви можете використати [генератор шаблона мода Fabric](https://fabricmc.net/develop/template/), щоб створити новий проєкт для свого мода — вам слід заповнити обов’язкові поля, як-от назва мода, назва пакета, і версію Minecraft, для якої ви хочете розробляти.
...
Якщо ви хочете використовувати Kotlin, скрипти збірки Kotlin або хочете додати генератори даних, ви можете вибрати відповідні параметри в розділі `Advanced Options`.

::: info

У прикладах коду, наведених на цьому сайті, використовуються [імена, наявні в деобфускованій грі](../porting/mappings/#whats-going-on-with-mappings). Якщо у вас є наявний мод, який використовує мапінги, відмінні від тих, які надає Mojang, будь ласка, перегляньте [портування до 26.1](../porting/index), для подробиць.
...
### Налаштування вашої IDE {#setting-up}

Коли ви відкриєте проєкт в IDE, він має автоматично завантажити налаштування Gradle проєкту та виконати необхідні завдання налаштування.

Якщо ви отримали сповіщення про сценарій збирання Gradle, вам слід натиснути кнопку `Import Gradle Project`.

Для подробиць див. сторінку [налаштування вашої IDE](./setting-up).

### Змінення шаблону {#modifying-the-template}

Після того як проєкт буде імпортовано, ви повинні змінити деталі проєкту, щоб вони відповідали деталям вашого мода:
...
- Переконайтеся, що ви оновили версії Minecraft, мапінгів, Завантажувача і Loom — усе це можна отримати на [сайті розробки](https://fabricmc.net/develop/) — щоб відповідати версіям, які ви хочете націлити.

Ви можете змінити назву пакета та основний клас мода, щоб відповідати деталям вашого мода.
