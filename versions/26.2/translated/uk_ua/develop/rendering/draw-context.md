---
title: Малювання GUI
description: Узнайте як використовувати клас GuiGraphics для рендера різних форм, тексту та текстур.
authors:
  - IMB11
---
...
@[code lang=java transcludeWith=:::1](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::2](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::3](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::4](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::5](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::6](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::7](@/reference/26.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
