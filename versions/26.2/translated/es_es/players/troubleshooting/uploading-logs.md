...
## ¿Porqué debería subir los logs? {#why-should-i-upload-logs}
...
## Reportes de Crasheos {#crash-reports}
...
## Localizando los logs {#locating-logs}
...
## Subiendo Logs Online {#uploading-logs-online}
