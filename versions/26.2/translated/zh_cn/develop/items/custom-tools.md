...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#guidite_tool_material
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#guidite_incorrect_blocks_tag

接下来，我们使用标签 JSON 文件来定义该标签的具体内容。 这里设定 Guidite 工具可以挖掘木制工具能挖掘的方块，外加铜矿石和深层铜矿石：

<<< @/reference/26.2/src/main/resources/data/example-mod/tags/block/incorrect_for_guidite_tool.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#guidite_sword

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#guidite_sword

两个浮点数值 (`1f, 1f`) 分别表示工具的攻击伤害以及攻击速度。

对于锹、斧和锄，你应该创建 `ShovelItem`、`AxeItem` 或 `HoeItem`，而不是通用的 `Item`，因为这些实现了特定于工具的右键单击操作：

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#axe

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#axe
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#add_guidite_sword_to_create_tab
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#sword

== 客户端物品

`generated/assets/example-mod/items/guidite_sword.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/guidite_sword.json

== 物品模型

`generated/assets/example-mod/models/item/guidite_sword.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/guidite_sword.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModItemTagProvider.java#sword_tags
