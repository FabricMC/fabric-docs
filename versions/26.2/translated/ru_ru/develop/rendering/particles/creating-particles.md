...
Все фабрики частиц можно увидеть, просмотрев все реализации интерфейса `ParticleProvider`. Это полезно, если вы хотите использовать поведения других частиц для вашей собственной частицы.

- Горячая клавиша для IntelliJ: <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>B</kbd>
- Горячая клавиша для Visual Studio Code: <kbd>Ctrl</kbd>+<kbd>F12</kbd>
