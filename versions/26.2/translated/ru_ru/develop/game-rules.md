...
<<< @/reference/26.2/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java#gamerule_class
...
<<< @/reference/26.2/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java#double
...
<<< @/reference/26.2/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java#badvision_get

Также через этот метод можно получить значения ванильных игровых правил:

<<< @/reference/26.2/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java#vanilla

Например, для правила, которое накладывает слепоту на каждого игрока, если оно установлено в `true`, реализация будет такой:

<<< @/reference/26.2/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java#badvision_implement
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java#gamerule_name
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java#gamerule_description
