...
@[code transcludeWith=:::1](@/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code transcludeWith=:::1](@/reference/26.2/src/main/java/com/example/docs/block/ExampleModBlocks.java)
...
@[code transcludeWith=:::2](@/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code transcludeWith=:::6](@/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code](@/reference/26.2/src/main/generated/assets/example-mod/models/block/condensed_dirt.json)
...
@[code](@/reference/26.2/src/main/generated/assets/example-mod/items/condensed_dirt.json)
...
@[code](@/reference/26.2/src/main/generated/assets/example-mod/blockstates/condensed_dirt.json)
...
@[code](@/reference/26.2/src/main/resources/data/example-mod/loot_tables/blocks/condensed_dirt.json)
...
@[code](@/reference/26.2/src/main/resources/data/minecraft/tags/mineable/shovel.json)
