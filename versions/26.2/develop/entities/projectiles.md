...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#entity
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#constructors

### Overriding `getDefaultItem()` {#override-get-default-item}

Defines the item form of this projectile.

<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#default_item
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#on_hit_block
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#on_hit_entity
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterEntity.java#on_hit
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterItem.java#item
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterItem.java#as_projectile
...
<<< @/reference/26.2/src/main/java/com/example/docs/projectile/HotTaterItem.java#use
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#hot_tater

Then register the item in `ModItems`, alongside the others:

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#hot_tater
...
<<< @/reference/26.2/src/main/java/com/example/docs/entity/ModEntityTypeIds.java#hot_tater
...
<<< @/reference/26.2/src/main/java/com/example/docs/entity/ModEntityTypes.java#hot_tater

Finally, let's use the vanilla `ThrownItemRenderer` in the client initializer:

<<< @/reference/26.2/src/client/java/com/example/docs/projectile/ExampleModProjectileClient.java#renderer
