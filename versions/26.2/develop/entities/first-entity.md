...
<<< @/reference/26.2/src/main/java/com/example/docs/entity/ModEntityTypeIds.java#ids
...
<<< @/reference/26.2/src/main/java/com/example/docs/entity/ExampleModEntity.java#entrypoint
