...
<<< @/reference/26.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#abstract_fluid

Inside `AcidFluid`, we'll create two subclasses for the `Source` and `Flowing` fluids.

<<< @/reference/26.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#fluid_subclasses

### Registering Fluids {#registering-fluids}

Next, we'll create a class to store all the fluid ids. We'll call it `ModFluidIds`.

<<< @/reference/26.2/src/main/java/com/example/docs/fluid/ModFluidIds.java#register

We'll use those IDs in a new class to register all the fluid instances. We'll call it `ModFluids`.

<<< @/reference/26.2/src/main/java/com/example/docs/fluid/ModFluids.java#register
...
<<< @/reference/26.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#sources
...
<<< @/reference/26.2/src/main/java/com/example/docs/block/ModBlockIds.java#acid

Then, open your `ModBlocks` class and register this following `LiquidBlock` using that key:

<<< @/reference/26.2/src/main/java/com/example/docs/block/ModBlocks.java#acid

Then, override this method in `AcidFluid` to associate your block with the fluid:

<<< @/reference/26.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#legacy_block
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#acid_bucket

Then, override this method in `AcidFluid` to associate your bucket with the fluid:

<<< @/reference/26.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#bucket
...
<<< @/reference/26.2/src/main/generated/data/example-mod/tags/fluid/acid.json
...
<<< @/reference/26.2/src/main/generated/data/minecraft/tags/fluid/water.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java#fluid_texture
