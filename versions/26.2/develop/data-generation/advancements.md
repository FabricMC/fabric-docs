...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#datagen_advancements_provider_start

To finish setup, add this provider to your `DataGeneratorEntrypoint` within the `onInitializeDataGenerator` method.

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java#datagen_advancements_register
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#datagen_advancements_simple_advancement

::: details JSON Output

<<< @/reference/26.2/src/main/generated/data/example-mod/advancement/get_dirt.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#reference_parent
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#placeholder_parent
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#multiple_criteria
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#requirements_strategy
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#experience_reward

There are multiple other reward types available:

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#reward_types
...
<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ExampleModDatagenAdvancement.java#datagen_advancements_entrypoint
...
<<< @/reference/26.2/src/main/java/com/example/docs/advancement/UseToolCriterion.java#datagen_advancements_criterion_base
...
<<< @/reference/26.2/src/main/java/com/example/docs/advancement/UseToolCriterion.java#datagen_advancements_conditions_test

Now that we've got a criterion and its conditions, we need a way to trigger it. Add a trigger method to `UseToolCriterion`:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/UseToolCriterion.java#datagen_advancements_criterion_trigger
...
<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ModCriteria.java#datagen_advancements_mod_criteria

To make sure that our criteria are initialized at the right time, add a blank `init` method:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ModCriteria.java#datagen_advancements_mod_criteria_init

And call it in your mod initializer:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ExampleModDatagenAdvancement.java#datagen_advancements_call_init

Finally, we need to trigger our criterion. Add this to where we sent a message to the player in the main mod class.

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ExampleModDatagenAdvancement.java#datagen_advancements_trigger_criterion

Your shiny new criterion is now ready to use! Let's add it to our provider:

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#datagen_advancements_custom_criteria_advancement
...
<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ParameterizedUseToolCriterion.java#datagen_advancements_new_requirements_met

`requiredTimes` doesn't exist, so make it a parameter of `Conditions`:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ParameterizedUseToolCriterion.java#datagen_advancements_new_parameter

Now our codec is erroring. Let's write a new codec for the new changes:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ParameterizedUseToolCriterion.java#datagen_advancements_new_codec

Moving on, we now need to fix our `trigger` method:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ParameterizedUseToolCriterion.java#datagen_advancements_new_trigger

If you've made a new criterion, we need to add it to `ModCriteria`

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ModCriteria.java#datagen_advancements_new_mod_criteria

And call it in our main class, right where the old one is:

<<< @/reference/26.2/src/main/java/com/example/docs/advancement/ExampleModDatagenAdvancement.java#datagen_advancements_trigger_new_criterion

Add the advancement to your provider:

<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#datagen_advancements_new_custom_criteria_advancement
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java#datagen_advancements_conditions
