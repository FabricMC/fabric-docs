...
resources:
  ...
  https://github.com/FabricMC/fabric-docs/tree/main/reference/26.2: ExampleMod referenced by these docs
...
In case you need it at any time, a fully-working mod with all the source code of this documentation is available in the [`/reference` folder on GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/26.2).
