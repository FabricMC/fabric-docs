...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderState.java#render_state

Then we create a `BlockEntityRenderer` for our `CounterBlockEntity`.

<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#renderer_structure
...
<<< @/reference/26.2/src/client/java/com/example/docs/ExampleModBlockEntityRenderer.java#register_block_entity_renderer
...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#create_render_state

`extractRenderState` can be used to update the render state with entity data.

<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#extract_render_state
...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#translate
...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#rotate
...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#scale

Now, the whole transformation looks like this:

<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#transformations
...
<<< @/reference/26.2/src/client/java/com/example/docs/rendering/blockentity/CounterBlockEntityRenderer.java#drawing_text
