...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#bone_marrow_resource

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#bone_marrow
