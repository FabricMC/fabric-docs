...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#quark_gluon_plasma_resource

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#quark_gluon_plasma
