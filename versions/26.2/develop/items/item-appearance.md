...
<<< @/reference/26.2/src/client/java/com/example/docs/appearance/RainTintSource.java#tint_source_class
...
<<< @/reference/26.2/src/client/java/com/example/docs/appearance/RainTintSource.java#map_codec

We can then return this Codec in `type()`.

<<< @/reference/26.2/src/client/java/com/example/docs/appearance/RainTintSource.java#return_codec
...
<<< @/reference/26.2/src/client/java/com/example/docs/appearance/RainTintSource.java#calculate
...
<<< @/reference/26.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java#register_item_tint_source

Once this is done, we can use our item tint source in a client item definition.

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/waxcap.json
