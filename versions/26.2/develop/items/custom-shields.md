...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#shield
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#shield

Remember to add it to a creative tab if you want to access it from the creative inventory!

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#add_guidite_shield_to_create_tab
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldLayers.java#layer

Then, register the layer in your client initializer:

<<< @/reference/26.2/src/client/java/com/example/docs/ExampleModClient.java#shield_layer
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldSpecialRenderer.java#renderer
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldSpecialRenderer.java#extract_argument
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldSpecialRenderer.java#extents
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldSpecialRenderer.java#submit
...
<<< @/reference/26.2/src/client/java/com/example/docs/item/shield/GuiditeShieldSpecialRenderer.java#unbaked
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java#shield

== Client Item

`generated/assets/example-mod/items/guidite_shield.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/items/guidite_shield.json

== Item Models

`generated/assets/example-mod/models/item/guidite_shield.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/guidite_shield.json

`generated/assets/example-mod/models/item/guidite_shield_blocking.json`

<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/guidite_shield_blocking.json
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java#shield_decoration
...
<<< @/reference/26.2/src/client/java/com/example/docs/datagen/ExampleModItemTagProvider.java#shield_tags
