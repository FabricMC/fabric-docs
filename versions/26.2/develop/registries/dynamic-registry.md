...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/MagicSkillsRegistryEntry.java#main
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#main

Call `ExampleModRegistries.initialize()` from your [mod's initializer](./getting-started/project-structure#entrypoints).

<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModDynamicRegistries.java#main
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#simple
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#synced
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/MagicSkillsRegistryEntry.java#client_codec
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#double_codec
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#with_option
...
<<< @/reference/26.2/src/main/generated/data/example-mod/example-mod/magic_skills_synced_registry/healing_skill.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#entry_id
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#get_registry
...
<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModRegistries.java#get_specific_registry_entry
...
<<< @/reference/26.2/src/client/java/com/example/docs/dynamic_registries/screens/ExampleModMagicSkillsScreen.java#iterate_over_registry_entries
...
<<< @/reference/26.2/src/main/generated/data/example-mod/tags/example-mod/magic_skills_synced_registry/attacking_skills.json

### Using Tags In Code {#using-tags-in-code}

Create a tag key for the tag to check if entries are present in the tag or not.

<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModTags.java#tag

We can use this method to check if a skill is an attacking skill or not.

<<< @/reference/26.2/src/main/java/com/example/docs/dynamic_registries/ExampleModTags.java#tag_usage
