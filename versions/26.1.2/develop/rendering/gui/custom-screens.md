...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/screens/CustomScreen.java#screen
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/screens/CustomScreen.java#return_to_previous_screen
