...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java#registration

**Implementation of `hudLayer()`:**

<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java#hud_layer
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java#scaling_square
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java#rotating_square
