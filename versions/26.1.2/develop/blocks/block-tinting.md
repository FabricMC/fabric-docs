...
<<< @/reference/26.1.2/src/main/java/com/example/docs/block/ModBlocks.java#waxcap_tinting
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java#color_provider
