...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#custom_creative_tab

<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#register_creative_tab
