...
<<< @/reference/26.1.2/src/main/java/com/example/docs/recipe/extending/EnchantingSmithingRecipe.java#enchanting_smithing
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/recipe/extending/EnchantingSmithingDemoSlotDisplay.java#slot_display
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/mixin/accessor/SlotDisplayAccessor.java#demo_invoker
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/recipe/ExampleModRecipes.java#enchanting_smithing_registration

::: info

This recipe is still data-driven.

<<< @/reference/26.1.2/src/main/resources/data/example-mod/recipe/smithing_enchanting/netherite_sword_smithing_enchanting.json
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/recipe/extending/StewSpikingCraftingRecipe.java#stew_spiking

As always, we need to register our recipe serializer.

<<< @/reference/26.1.2/src/main/java/com/example/docs/recipe/ExampleModRecipes.java#stew_spiking_registration

::: info

This recipe is still data-driven.

<<< @/reference/26.1.2/src/main/resources/data/example-mod/recipe/stew_spiking/stew_spiking.json
