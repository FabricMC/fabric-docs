...
Se você encontrar qualquer problema, por favor reporte-os [no GitHub](https://github.com/FabricMC/fabric-docs) ou peça ajuda no [Discord do Fabric](https://discord.fabricmc.net/) nos canais `#player-support` ou `#mc-server-support`.
