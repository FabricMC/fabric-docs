...
resources:
  ...
  https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2: ExampleMod a cui fa riferimento la documentazione
---
...
Nel caso ti servisse in qualunque momento, è disponibile una mod completamente funzionante con tutto il codice di questa documentazione nella [cartella `/reference` su GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2).
