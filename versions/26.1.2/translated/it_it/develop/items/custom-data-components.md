...
@[code transcludeWith=::2](@/reference/26.1.2/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::1](@/reference/26.1.2/src/main/java/com/example/docs/component/MyCustomComponent.java)
...
@[code transcludeWith=::2](@/reference/26.1.2/src/main/java/com/example/docs/component/MyCustomComponent.java)
