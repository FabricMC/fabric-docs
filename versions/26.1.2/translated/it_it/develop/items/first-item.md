...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#mod_items_class
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#suspicious_substance
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#initialize

<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ExampleModItems.java#initialize
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#add_to_creative_tab
...
<<< @/reference/26.1.2/src/main/generated/assets/example-mod/models/item/suspicious_substance.json
...
<<< @/reference/26.1.2/src/main/generated/assets/example-mod/items/suspicious_substance.json
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#compostable_item

In alternativa, se vuoi rendere il tuo oggetto combustibile, puoi usare l'evento `FuelValueEvents.BUILD`:

<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#fuel_item
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/custom/LightningStick.java#custom_tooltip
