...
@[code transcludeWith=#entrypoint](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModEnchantmentGenerator.java)
...
@[code transcludeWith=:::custom-enchantments:register-generator](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
