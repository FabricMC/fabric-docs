...
@[code lang=json](@/reference/26.1.2/src/main/generated/data/example-mod/advancement/get_dirt.json)
...
@[code lang=java transcludeWith=:::datagen-advancements:second-advancement](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModAdvancementProvider.java)
