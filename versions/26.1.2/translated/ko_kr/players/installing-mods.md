---
title: 모드 설치
description: Fabric용 모드를 설치하는 방법에 대한 단계별 가이드.
authors:
  - IMB11
---
...
모드를 다운로드할 때, 아래 사항을 확인하세요:

- 플레이하고자 하는 Minecraft 버전이 지원되는지 확인해야 합니다. 예를 들어, 버전 1.21.8을 지원하는 모드는 1.21.11에서 작동하지 않을 수 있습니다.
...
설치 과정 중 문제가 발생했다면, [Fabric 디스코드(영어)](https://discord.fabricmc.net/)의 `#player-support` 채널에서 도움을 요청할 수 있습니다.

스스로 문제 해결 페이지를 읽고 직접 문제를 해결할 수도 있습니다:

- [충돌 보고서에 대한 것](./troubleshooting/crash-reports)
