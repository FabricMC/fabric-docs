...
## 2. 下载并安装 Java 25 {#2-downloading-and-installing-java}

我们推荐使用 [Adoptium 构建的 OpenJDK 25](https://adoptium.net/temurin/releases?version=25&os=mac&arch=any&mode=filter)：
...
如果你已经安装了 [Homebrew](https://brew.sh)，则可以改用 `brew` 安装 Java 25：

```sh
brew install --cask temurin@25
```

## 3. 验证是否已安装 Java 25 {#3-verify-that-java-is-installed}

安装完成后，你可以再次打开终端并输入 `$(/usr/libexec/java_home -v 25)/bin/java --version` 来验证 Java 25 是否已安装。
