...
@[code lang=java transcludeWith=:::block](@/reference/26.1.2/src/main/java/com/example/docs/appearance/ExampleModAppearance.java)
...
@[code lang=java transcludeWith=:::block_render_layer_map](@/reference/26.1.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)
