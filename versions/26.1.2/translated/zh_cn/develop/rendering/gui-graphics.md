...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_rectangle
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_outline
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_line
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#scissor
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_entire_texture
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_portion_of_texture
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java#draw_text
