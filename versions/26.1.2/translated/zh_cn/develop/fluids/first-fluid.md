...
<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#abstract_fluid

在 `AcidFluid` 内部，我们会为 `Source` 和 `Flowing` 流体创建两个子类。

<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#fluid_subclasses

### 注册流体 {#registering-fluids}

接下来，我们会创建一个用于注册所有流体实例的类， 并将其命名为 `ModFluids`。

<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/ModFluids.java#register
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#sources
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/block/ModBlocks.java#acid

然后，在 `AcidFluid` 中重写以下方法，将你的方块与该流体关联起来：

<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#legacy_block
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#acid_bucket

然后，在 `AcidFluid` 中重写以下方法，将你的桶与该流体关联起来：

<<< @/reference/26.1.2/src/main/java/com/example/docs/fluid/custom/AcidFluid.java#bucket
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java#fluid_texture
