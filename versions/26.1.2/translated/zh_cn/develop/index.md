...
resources:
  ...
  https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2: 这些文档中引用的 ExampleMod
---
...
如果你需要，包含本文档所有代码的完整有效模组可在 [Github 中的 `/reference` 文件夹](https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2)中找到。
