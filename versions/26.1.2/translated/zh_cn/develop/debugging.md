...
<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java#problems_basic_logger_definition

每当你需要了解代码中任何一点的某个值时，请通过将 `String` 传递给其方法来使用此 `LOGGER`。

<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java#problems_using_logger

记录器支持多种模式将文本打印到控制台。 根据使用的模式，记录的行将以不同的颜色显示。

<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java#problems_log_levels
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java#problems_logger_usage_example
...
<<< @/reference/26.1.2/log4j-dev.xml

然后在 `build.gradle` 中，告诉 Loom 使用我们的新配置。

<<< @/reference/26.1.2/build.gradle#debug_logging

现在，当我们发送调试日志消息时，我们将能够在控制台中看到它们。

<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java#problems_debug_logging
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java#problems_breakpoints
