...
Цей посібник допоможе вам установити Java 25 на macOS.
...
Зверніть увагу на номер версії: у наведеному вище прикладі це `25.0.9`.
...
Ми рекомендуємо використовувати [збірку OpenJDK 25 від Adoptium](https://adoptium.net/temurin/releases?version=25&os=mac&arch=any&mode=filter):

![Сторінка завантаження Temurin Java](/assets/players/installing-java/macos-download-java.png)

Переконайтеся, що вибрано версію «25 — LTS» і виберіть формат установлювача `.PKG`.
...
Якщо у вас уже встановлено [Homebrew](https://brew.sh), ви можете встановити Java 25 за допомогою `brew`:
...
Після завершення встановлення ви можете переконатися, що Java 25 активна, знову відкривши термінал і ввівши `$(/usr/libexec/java_home -v 25)/bin/java --version`.
