...
Після генерації цілей запуску ви можете використовувати їх, відкривши вікно **Run and Debug**, вибравши потрібну ціль і натиснувши кнопку **Start Debugging** (<kbd>F5</kbd>).
