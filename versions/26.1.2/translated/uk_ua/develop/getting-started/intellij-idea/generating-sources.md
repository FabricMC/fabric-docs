...
Інструментарій Fabric дає вам доступ до початкового коду Minecraft, генеруючи його локально, і ви можете використовувати IntelliJ IDEA для зручної навігації по ньому. Щоб згенерувати джерела, потрібно запустити завдання Gradle `genSources`.
...
Для цього відкрийте будь-який клас Minecraft. Ви можете <kbd>Ctrl</kbd> + натиснути, щоб перейти до визначення, яке відкриває клас, або скористайтеся функцією «Search everywhere», щоб відкрити клас.

Відкриймо `MinecraftServer.class` як приклад. Тепер ви повинні побачити синій банер угорі з посиланням «**Choose Sources…**».

![Вибір джерел](/assets/develop/getting-started/intellij/choose-sources.png)

Натисніть «**Choose Sources…**», щоб відкрити діалогове вікно вибору файлів. Усталено це діалогове вікно відкриється у правильному місці згенерованих джерел.

Виберіть файл, який закінчується на **`-sources`**, і натисніть **Open**, щоб підтвердити вибір.
