...
resources:
  ...
  https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2: ExampleMod, на який посилаються у цій документації
---
...
Якщо вам це знадобиться в будь-який час, повністю робочий мод з усім початковим кодом цієї документації доступний у теці [`/reference` на GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2).
