...
<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#custom_food

Ähnlich wie in dem Beispiel auf der Seite [Dein erstes Item erstellen](./first-item) werde ich den obigen Component verwenden:

<<< @/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java#poisonous_apple
