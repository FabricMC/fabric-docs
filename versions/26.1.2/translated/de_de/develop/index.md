...
resources:
  ...
  https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2: In der Dokumentation referenzierte ExampleMod
---
...
Falls du es zu irgendeinem Zeitpunkt benötigst, steht dir ein voll funktionsfähiger Mod mit dem gesamten Quellcode dieser Dokumentation im Ordner [`/reference` auf GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/26.1.2) zur Verfügung.
