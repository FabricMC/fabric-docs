...
<<< @/reference/26.1.2/src/client/java/com/example/docs/ExampleModDynamicSound.java#simple_sound_instance
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/instance/CustomSoundInstance.java#custom_sound_instance
...
Wenn du feststellst, dass deine Werte nicht übereinstimmen, stelle sicher, dass deine Werte
entweder mit dem `EntityDataAccessor` der Entität, den clientgebundenen Paketen von `BlockEntity` oder vollständigen benutzerdefinierten clientgebundenen Netzwerkpaketen synchronisiert sind.
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/ExampleModDynamicSound.java#custom_sound_instance
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/sound/DynamicSoundSource.java#dynamic_sound_source
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/sound/TransitionState.java#transition_state
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/instance/SoundInstanceCallback.java#sound_instance_callback
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#class_fields

Lege dann die Standard-Startwerte für die benutzerdefinierte `SoundInstance` im Konstruktor der abstrakten Klasse fest.

<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#constructor

Nachdem der Konstruktor fertig ist, musst du der `SoundInstance` erlauben, zu spielen.

<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#can_start
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#tick
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#modulation
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#other
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/instance/EngineSoundInstance.java#engine_sound_instance
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/DynamicSoundManager.java#sound_manager_structure
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/sound/DynamicSoundManager.java#sound_manager_methods
...
Um dieses Soundsystem zu verwenden, musst du entweder die Methoden von `DynamicSoundManager` oder die Methoden von `SoundInstance` verwenden. Unter Verwendung von `onStartedTrackingBy` und `onStoppedTrackingBy` von Entitäten oder mithilfe von [benutzerdefiniertem clientgebundenem Networking](../networking#receiving-a-packet-on-the-client) kannst du jetzt deine benutzerdefinierten dynamischen `SoundInstance`s starten und stoppen.

<<< @/reference/26.1.2/src/client/java/com/example/docs/network/ClientboundSoundReceiver.java#handle_packet
