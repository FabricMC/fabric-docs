...
<<< @/reference/26.1.2/src/main/java/com/example/docs/entity/ModEntityTypes.java#types
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java#goals
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/state/MiniGolemEntityRenderState.java#entitystate
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java#model1
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java#model_texture_data
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/model/ModEntityModelLayers.java#model_layer

Diese Klasse muss dann im Client-Initialisierer des Mods initialisiert werden.

<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/ExampleModCustomEntityClient.java#register_client
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/renderer/MiniGolemEntityRenderer.java#renderer
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/ExampleModCustomEntityClient.java#register_renderer
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java#model_animation
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java#datatracker
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java#savedata
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java#dancing_animation
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/animation/MiniGolemAnimations.java#dancing_animation
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/state/MiniGolemEntityRenderState.java#animation_state

Um die Kopie durchzuführen, überschreiben wir die Methode `extractRenderState` im Entity-Renderer.

<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/renderer/MiniGolemEntityRenderer.java#copy_animation_state

Zum Schluss, lasst uns die Animation mit dem Modell verbinden:

<<< @/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java#dancing_animation
