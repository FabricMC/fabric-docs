...
Если вы хотите добавить эффекты статуса игроку, когда он ест вашу еду, вам нужно будет использовать `ConsumableComponent` вместе с классом `FoodProperties`, как показано в следующем примере:
