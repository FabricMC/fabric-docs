...
@[code lang=json](@/reference/1.21.8/src/main/resources/assets/fabric-docs-reference/sounds.json)
...
@[code lang=java transcludeWith=:::1](@/reference/1.21.8/src/main/java/com/example/docs/sound/CustomSounds.java)
...
@[code lang=java transcludeWith=:::2](@/reference/1.21.8/src/main/java/com/example/docs/sound/FabricDocsReferenceSounds.java)
