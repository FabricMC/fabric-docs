...
@[code](@/reference/1.21.8/src/main/resources/assets/fabric-docs-reference/models/block/condensed_dirt.json)
...
@[code](@/reference/1.21.8/src/main/resources/assets/fabric-docs-reference/models/item/condensed_dirt.json)
...
@[code](@/reference/1.21.8/src/main/resources/assets/fabric-docs-reference/blockstates/condensed_dirt.json)
