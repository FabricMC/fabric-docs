...
<template>
  <div :class="`version-reminder ${version !== CURRENT_VERSION ? 'old-version' : ''}`">
    <div class="icon">
      <svg v-if="version !== CURRENT_VERSION" version="1.1" id="Capa_1" width="25%" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 478.125 478.125" xml:space="preserve">
        <g>
          <g>
            <g>
              <circle stroke-width="7px" cx="239.904" cy="314.721" r="35.878" />
              <path stroke-width="7px" d="M256.657,127.525h-31.9c-10.557,0-19.125,8.645-19.125,19.125v101.975c0,10.48,8.645,19.125,19.125,19.125h31.9
				c10.48,0,19.125-8.645,19.125-19.125V146.65C275.782,136.17,267.138,127.525,256.657,127.525z" />
              <path stroke-width="7px" d="M239.062,0C106.947,0,0,106.947,0,239.062s106.947,239.062,239.062,239.062c132.115,0,239.062-106.947,239.062-239.062
      ...
      <svg v-else version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="0 0 469.184 469.185"
        xml:space="preserve">
        <g>
          <path
