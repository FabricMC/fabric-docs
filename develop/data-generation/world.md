...
In your Placed Features class's method with the argument of `BootstrapContext<PlacedFeature>` create a variable like the one below:
...
- **CountPlacement** - Roughly the amount of instances of this feature per chunk (in this case veins per chunk)
