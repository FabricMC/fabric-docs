...
<<< @/reference/latest/src/client/java/com/example/docs/rendering/TextTests.java#component-to-string
...
<<< @/reference/latest/src/client/java/com/example/docs/rendering/TextTests.java#string-to-component
