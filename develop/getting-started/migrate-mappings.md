...
### Reporting issues
Loom uses [https://github.com/CadixDev/Mercury](Mercury) to remap Java source code, for problems with remapping please report issues to their [https://github.com/CadixDev/Mercury/issue](issue tracker), or discuss it through their communications channel (irc.esper.net #cadix).
