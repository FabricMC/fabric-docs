...
A mod is a jar with a [`fabric.mod.json`](./fabric-mod-json) metadata file in its root declaring how it should be loaded. That file contains a mod ID and version number, as well as [entrypoints](https://wiki.fabricmc.net/documentation:entrypoint) and mixin configurations.
