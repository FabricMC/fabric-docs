...
This translation changed with the release of `1.16-rc1`. Previously, Fabric normalized prereleases like `1.16-pre1` to `1.16-rc.1`, which now conflicts. `1.16-rc1` is normalized to `1.16-rc9`, and future prereleases are normalized to `-beta.n`
