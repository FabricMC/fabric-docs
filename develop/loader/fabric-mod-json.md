...
You can consult the [full specification for `fabric.mod.json` v1](https://github.com/FabricMC/fabric-loom/blob/-/src/main/java/net/fabricmc/loom/api/fmj/FabricModJsonV1Spec.java)).
...
Fabric Loader provides those three main entrypoints, but other mods may provide their own. For example, Fabric API also provides `fabric-datagen`.
