...
An Intellij IDEA migration map is also available to help automate the renaming process. After downloading follow the instructions in the [JetBrains documentation](https://www.jetbrains.com/help/idea/migrate.html) to apply it to your project.
