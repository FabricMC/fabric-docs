...
3. Bump Minecraft, Fabric Loader, and Fabric API, either in your `gradle.properties` (recommended) or in your `build.gradle`. Find the latest versions of the Fabric components on the [Develop site](https://fabricmc.net/develop/).
4. Refresh Gradle.
...
- [_Minecraft: Java Edition 1.21.11_ on the Minecraft blog post](https://www.minecraft.net/en-us/article/minecraft-java-edition-1-21-11) is the official overview of the features introduced in 1.21.11.
