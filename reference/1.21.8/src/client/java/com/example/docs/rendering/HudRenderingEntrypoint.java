...
public class HudRenderingEntrypoint implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		HudElementRegistry.attachElementBefore(VanillaHudElements.CHAT, ResourceLocation.fromNamespaceAndPath(FabricDocsReference.MOD_ID, "before_chat"), HudRenderingEntrypoint::render);
	}
