...
public class ExampleModDamageTypesProvider {
	...
	public static class TaterDamageTypeTagGenerator extends FabricTagProvider<DamageType> {
		...
		protected void addTags(HolderLookup.Provider arg) {
			tag(TagKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("minecraft:bypasses_armor"))).add(ExampleModDamageTypes.TATER_DAMAGE);
		}
	}
	...
	public static class TaterDamageTypesGenerator implements DataProvider {
		...
		public CompletableFuture<?> run(CachedOutput writer) {
			...
			return DataProvider.saveStable(writer, damageTypeObject, path.json(ResourceLocation.fromNamespaceAndPath("example-mod", "tater")));
		}
