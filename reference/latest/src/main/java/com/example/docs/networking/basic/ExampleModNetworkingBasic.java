...
public class ExampleModNetworkingBasic implements ModInitializer {
	public static final RegistryKey<Item> LIGHTNING_TATER_REGISTRY_KEY = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(ExampleMod.MOD_ID, "lightning_tater"));
	public static final Item LIGHTNING_TATER = Registry.register(Registries.ITEM, Identifier.of(ExampleMod.MOD_ID, "lightning_tater"), new LightningTaterItem(new Item.Settings().registryKey(LIGHTNING_TATER_REGISTRY_KEY)));
