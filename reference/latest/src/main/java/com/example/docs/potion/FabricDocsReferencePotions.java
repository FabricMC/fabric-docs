...
import com.example.docs.mixin.potion.BrewingRecipeRegistryInvoker;
...
public class FabricDocsReferencePotions implements ModInitializer {
	...
	public void onInitialize() {
		// When Fabric API is present, you can directly use BrewingRecipeRegistry.registerPotionRecipe, as it is made accessible for you
