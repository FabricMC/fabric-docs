...
public class ExampleModDamageTypesProvider {
	...
	public static class TaterDamageTypeTagGenerator extends FabricTagProvider<DamageType> {
		...
		protected void configure(RegistryWrapper.WrapperLookup arg) {
			builder(TagKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.of("minecraft:bypasses_armor"))).add(ExampleModDamageTypes.TATER_DAMAGE);
		}
	}
	...
	public static class TaterDamageTypesGenerator implements DataProvider {
		...
		public CompletableFuture<?> run(DataWriter writer) {
			...
			return DataProvider.writeToPath(writer, damageTypeObject, path.resolveJson(Identifier.of(ExampleMod.MOD_ID, "tater")));
		}
