...
public class ExampleModDamageTypes implements ModInitializer {
	...
	public void onInitialize() {
		Registry.register(Registries.BLOCK, new Identifier("fabric-docs-reference", "tater"), TATER_BLOCK);
		Registry.register(Registries.ITEM, new Identifier("fabric-docs-reference", "tater"), new BlockItem(TATER_BLOCK, new Item.Settings()));
	}
}
