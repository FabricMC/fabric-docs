---
title: Avviare il Gioco in IntelliJ IDEA
description: Impara come usare i vari profili d'avvio per avviare ed effettuare debug delle tue mod in un ambiente di gioco dal vivo tramite IntelliJ IDEA.
authors:
  - IMB11
  - Tenneb22
prev:
