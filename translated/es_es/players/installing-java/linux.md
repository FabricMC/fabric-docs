...
Esta guía te mostrará como instalar Java 17 en Linux.

## 1. Verifica si Java ya está instalando.

Abre la terminal y escribe 'java -version' y presiona <kbd>Enter</kbd>.
