...
Einen Kreativtab zu erstellen ist recht einfach. Erstelle einfach ein neues statisches finales Feld in deiner Itemklasse, um den Kreativtab und einen Ressourcen Schlüssel dafür zu speichern, du kannst das `ItemGroupEvents.modifyEntriesEvent` von Fabric ähnlich zu dem, wie du deine Items zu den Vanilla Kreativtabs hinzugefügt hast, verwenden:
