...
:::details Migration von Ausführungskonfigurationen von der alten API

Die neue Property basierte API ist ab Loom 1.17 verfügbar.

Ersetze die alten Methoden und Eigenschaften zur Ausführungskonfiguration durch deren eigenschaftsbasierten Entsprechungen:

| Alte API                                       | Property basierte API                                                   |
| ---------------------------------------------- | ----------------------------------------------------------------------- |
