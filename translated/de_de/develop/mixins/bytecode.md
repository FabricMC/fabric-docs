...
Minecraft 1.21.10 bietet dies jedoch standardmäßig nicht und gilt daher als verschleiert. Beachte, dass [zukünftige Versionen von Minecraft nicht verschleiert werden](../migrating-mappings/#whats-going-on-with-mappings).
:::
...
Holt den obersten Wert des Operandenstapels und gibt ihn zurück.
Die Methode gibt den Zeiger auf die Instanz `Creeper` zurück.
