...
description: Ein Schritt-für-Schritt-Leitfaden zur Installation von Fabric auf Windows.
authors:
  - Benonardo
  - ezfe
  - IMB11
...
Wenn du Probleme hast, kannst du gerne im [Fabric Discord](https://discord.gg/v6v4pMv) im Kanal `#player-support` um Hilfe bitten.
