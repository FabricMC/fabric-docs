...
首先，信任是主觀的，當下載模組時您應該始終根據自己的判斷。 但是，有一些方法可以幫助您找到可信任的模組。 但是，有一些方法可以幫助您找到可信任的模組。
...
:::info
惡意軟體網站對於每個人來說可能不是很明顯。 如果您不確定，你應該向他人尋求意見，或者完全避免該網站，僅依賴於可信任的來源，如 Modrinth 和 CurseForge。
:::
