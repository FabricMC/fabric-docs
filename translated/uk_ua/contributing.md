...
2. Створіть нову гілку вашого форка
...
#### Клонування вашого форка {#clone-your-fork}
...
Фреймворк стосується внутрішньої структури сторінки, будь-які запити на зміни, які змінюють каркас сторінки, позначатимуться міткою <Badge type="tip">framework</Badge>.
...
:::info
Зміна файлів бічної панелі та налаштування навігаційної панелі не вважається фреймворком запита на зміни.
:::
...
Якщо ви створюєте або змінюєте сторінки, що містять код, розмістіть код у відповідному місці в прикладі мода (розташованого в теці `/reference` репозиторію). Потім скористайтеся [функцією фрагмента коду, запропонованою VitePress](https://vitepress.dev/guide/markdown#import-code-snippets), щоб вставити код.
