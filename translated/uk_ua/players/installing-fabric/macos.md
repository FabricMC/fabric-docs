...
Ви можете отримати попередження про те, що Apple не може перевірити `.jar`. Щоб обійти це, System Settings > Privacy & Security і безпека та натиснути `Open Anyway`. Підтвердьте та введіть пароль адміністратора, якщо буде запропоновано.
