...
Ви можете отримати попередження про те, що Apple не може перевірити `.jar`. Щоб обійти це, відкрийте System Settings > Privacy & Security та натисніть `Open Anyway`. Підтвердьте та введіть пароль адміністратора, якщо буде запропоновано.
