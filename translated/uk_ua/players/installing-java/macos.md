...
:::warning
Щоб використовувати Minecraft 1.21.10, вам потрібно встановити принаймні Java 21.
...
- Виконайте ці [інструкції, щоб дізнатися, який чип встановлено у вашому Mac](https://support.apple.com/en-us/116943)
