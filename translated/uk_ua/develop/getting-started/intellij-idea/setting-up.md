...
Ви можете встановити його, відкривши IntelliJ IDEA, а потім перейшовши до **Файл** > **Налаштування** > **Плаґіни** > вкладка **Ринок**, потім знайдіть `Minecraft Development` у рядку пошуку та натисніть кнопку **Установити**.

Крім того, ви можете завантажити його зі [сторінки плаґінів](https://plugins.jetbrains.com/plugin/8327-minecraft-development), а потім установити, перейшовши до **Файл** > **Налаштування** > **Плаґіни** > **Установити плаґін з диска**.
