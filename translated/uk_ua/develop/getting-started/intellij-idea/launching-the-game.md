...
Переконайтеся, що шлях до проєкту та ім’я користувача в операційній системі містять лише символи ASCII (літери, цифри, дефіси, символи підкреслення та крапки). Не ASCII символи (наприклад, емодзі або літери з діакритичними знаками), можуть спричинити проблеми з кодуванням і помилки розбору командного рядка в певних інструментах збірки чи скриптах. Також див. [посібник зі створення проєкту](../creating-a-project).
...
У IntelliJ IDEA ви можете знайти Mixin Library Jar в розділі «External Libraries» розділу «Project»:

![Mixin Library](/assets/develop/getting-started/mixin-library.png)

Вам потрібно буде скопіювати «Absolute Path» банки для наступного кроку.
