...
- Переконайтеся, що ви оновили версії Minecraft, мапування, звантажувач і Loom, які можна отримати через <https://fabricmc.net/develop/>, щоби відповідати версіям, на які ви хочете націлити.
