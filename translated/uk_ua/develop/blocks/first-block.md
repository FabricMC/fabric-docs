...
Подібно до предметів, блоки приймають у своєму конструкторі клас `BlockBehavior.Properties`, який визначає властивості блоку, такі як його звукові ефекти та рівень видобутку.
...
:::tip
Вам потрібно створити клієнтський елемент, лише якщо ви зареєстрували `BlockItem` разом зі своїм блоком!
:::
...
Якщо ви бажаєте, щоб для видобутку блока був потрібний інструмент, додайте `.requiresTool()` до налаштувань блока, а також додайте відповідний теґ рівня видобутку.

## Рівень добування {#mining-levels}
