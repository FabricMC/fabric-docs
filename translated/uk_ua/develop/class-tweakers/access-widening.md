...
[Linkie](https://linkie.shedaniel.dev) – це сайт, який дає змогу переглядати та перекладати різні мапінги. Він також надає записи розширювачів доступу для класу, методу або поля, які ви переглядаєте.

По-перше, переконайтеся, що ви вибрали правильну версію та мапінги в меню ліворуч:

![Правильна версія та мапінги, вибрані на Linkie](/assets/develop/class-tweakers/access-widening/linkie-version-mappings-select.png)

Потім знайдіть елемент, який ви бажаєте змінити, і під результатом запис розширювача доступу буде вказано як `AW`:

![Результат пошуку в Linkie](/assets/develop/class-tweakers/access-widening/linkie-search-results.png)
