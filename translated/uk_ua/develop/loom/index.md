...
Loom має 2 основних ID плаґіна, залежно від того, чи розробляєте ви на основі обфускованої версії Minecraft чи ні:

- `net.fabricmc.fabric-loom` використовуватиметься для версій без обфускації (Minecraft 26.1 або новішої).
- `net.fabricmc.fabric-loom-remap` для використання в обфускованих версіях (Minecraft 1.21.11 або старіших).

Застарілий ID плаґіна `fabric-loom` залишається для збереження зворотної сумісності з наявними проєктами в обфусцованих версіях. `net.fabricmc.fabric-loom-companion` також використовується в розширених налаштуваннях кількох проєктів, див. [групи шляхів класів](classpath-groups.md#multi-project) для отримання додаткової інформації.
