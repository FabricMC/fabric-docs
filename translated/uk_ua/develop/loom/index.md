...
- `include`: оголошує залежність, яку слід включити як jar усередині jar у кінцевий вихід мода. Це налаштування залежності не є транзитивною. Для залежностей, не пов’язаних із модами, Loom згенерує файл jar мода з `fabric.mod.json`, використовуючи ID мода як назву та ту саму версію
