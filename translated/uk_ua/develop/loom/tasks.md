...
Наведений вище приклад є найпростішим використанням завдання, у якому буде створено файл `fabric.mod.json` із зазначеним ID мода та версією. Блок `json` підтримує всі поля, визначені в [схемі JSON мода Fabric](https://fabricmc.net/wiki/documentation:fabric_mod_json). Див. [FabricModJsonV1Spec](https://github.com/FabricMC/fabric-loom/blob/dev/1.12/src/main/java/net/fabricmc/loom/api/fmj/FabricModJsonV1Spec.java), щоб отримати повний список підтримуваних властивостей.
