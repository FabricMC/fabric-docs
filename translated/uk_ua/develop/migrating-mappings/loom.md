...
## Міграція да мапінгів Mojang {#migrating-to-mojmap}
...
По-перше, вам потрібно запустити команду `migrateMappings`, яка перетворить ваші поточні мапінги на мапінги Yarn. Це можна знайти на [сайті розробки](https://fabricmc.net/develop) у розділі «Міграція мапінгів». На приклад:
...
Якщо ви використовуєте старішу версію Loom, див. [інші конфігурації](#other-configurations).
