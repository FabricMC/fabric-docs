...
:::info
У цих документах обговорюється мігрування із **1.21.10** на **1.21.11**. Якщо ви шукаєте іншу міграцію, перейдіть до цільової версії за допомогою спадного меню у верхньому правому куті.
:::
...
2. Оновіть Minecraft, Fabric Loader, Fabric Loom і Fabric API у `gradle.properties` (рекомендовано) або `build.gradle`. Знайдіть рекомендовані версії компонентів Fabric на [сайті розробки Fabric](https://fabricmc.net/develop/).
