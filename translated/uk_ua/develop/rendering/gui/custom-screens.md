...
Щоб створити екран, вам потрібно розширити клас `Screen` і перевизначити метод `init` — ви також можете перевизначити метод `render`, але переконайтеся, що викликаєте його суперметод, інакше він не рендеритиме тло, віджети тощо.
...
- Метод `render` називається кожним кадром — ви можете отримати доступ до графіки GUI та позиції миші з цього методу.
