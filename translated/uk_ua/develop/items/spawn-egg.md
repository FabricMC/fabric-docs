...
Є ще кілька речей, які потрібно зробити, перш ніж він буде готовий: ви повинні додати текстуру, модель предмета, клієнтський предмет, ім’я та додати яйце виклику до відповідної творчої вкладки.
...
Створіть JSON клієнтського предмета в каталозі `assets/example-mod/items` з тим самим іменем файлу, що й ID моделі предмета: `custom_spawn_egg.json`.
...
## Іменування яйця виклику {#naming-the-spawn-egg}
