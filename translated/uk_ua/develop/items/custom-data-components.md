...
Ми підемо до третього варіанту. Тож разом із додаванням значення компонентами усталено також перевіримо, чи присутній компонент у стосі, і покажемо лише підказку, якщо вона є.
...
![Спливна підказка показує «Використано 8 разів»](/assets/develop/items/custom_component_3.png)
