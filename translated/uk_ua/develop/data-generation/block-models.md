...
Ви можете переглянути приклади тестів у [Fabric API](https://github.com/FabricMC/fabric/blob/1.21.10/fabric-data-generation-api-v1/src/) та [прикладному моді](https://github.com/FabricMC/fabric-docs/tree/main/reference) цієї документації, щоб дізнатися більше.
