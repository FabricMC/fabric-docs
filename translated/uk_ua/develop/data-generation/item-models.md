...
Ви можете знайти точні усталені значення для обертання, масштабування та позиціювання моделі у файлі [`generated.json` з ресурсів Minecraft](https://mcasset.cloud/1.21.10/assets/minecraft/models/item/generated.json).
...
Ви можете знайти точні усталені значення для обертання, масштабування та позиціювання моделі у файлі [`handheld.json` з ресурсів Minecraft](https://mcasset.cloud/1.21.10/assets/minecraft/models/item/handheld.json).
...
Відтворює модель предмета на основі значення певної властивості. Ось деякі з них:
...
Ви можете переглянути приклади тестів у [Fabric API](https://github.com/FabricMC/fabric/blob/1.21.10/fabric-data-generation-api-v1/src/), [прикладний мод](https://github.com/FabricMC/fabric-docs/tree/main/reference) цієї документації для отримання додаткової інформації.
