...
Однак Minecraft 1.21.10 не надає цього усталено і тому називається обфускованим. Зауважте, що [майбутні версії Minecraft буде деобфускованими](../migrating-mappings/#whats-going-on-with-mappings).
:::
...
Завантажує змінну зі слота ТЛЗ 1 («зсув») і надсилає її значення до стеку операндів.
...
Оскільки [конструктори повертають `void`](#constructors-and-static-initializers), стек операндів втрачає один із двох покажчиків на `Creeper`.
