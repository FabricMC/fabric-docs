...
Аби ваш мод не засмічував файли журналів, виберіть відповідний рівень журналів для ваших журналів. Якщо дані, які ви реєструєте, актуальні лише під час розробки, настійно рекомендується використовувати рівень `debug`.

::: warning

Рівень `debug` усталено приховано, аби показати його під час розробки, див. [журнал налагодження](#debug-logging).

:::

Якщо ви все ще не впевнені, який рівень журналу вибрати, хороше емпіричне правило полягає в тому, аби використовувати лише неналагоджувальні рівні, якщо щось пішло не так. Розробників і користувачів пакетів модів не дуже хвилює, наприклад, ініціалізація предметів; вони хотіли б знати, якщо, наприклад, чому пакет даних не завантажується правильно.
...
Якщо повідомлення про налагодження все ще показано, ваші налаштування запуску можуть бути застарілими. Аби виправити це, повторно згенеруйте їх за допомогою завдання Gradle для вашої IDE.
