...
Ось деякі ресурси, які можуть допомогти вам ознайомитися з Java та OOP:
...
- [Medium: Вступ до OOP](https://medium.com/@Adekola_Olawale/beginners-guide-to-object-oriented-programming-a94601ea2fbd)

## Що пропонує Fabric? {#what-does-fabric-offer}

Проєкт Fabric зосереджений навколо трьох основних компонентів:

- **Fabric Loader**: гнучкий, незалежний від платформи завантажувач модів, в основному розроблений для Minecraft: Java Edition
