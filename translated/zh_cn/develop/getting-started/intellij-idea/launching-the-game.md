---
title: 在 IntelliJ IDEA 中启动游戏
description: 了解如何利用各种启动配置文件通过 IntelliJ IDEA 在实时游戏环境中启动和调试你的模组。
authors:
  - IMB11
  - Tenneb22
prev:
...
请确保你的项目路径和操作系统用户名仅包含 ASCII 字符（字母、数字、连字符、下划线和点）。 非 ASCII 字符（例如汉字、表情符号或带重音符号的字母）可能会导致某些构建工具或脚本出现编码问题和命令行解析错误。 另请参阅：[项目创建指南](../creating-a-project)。
