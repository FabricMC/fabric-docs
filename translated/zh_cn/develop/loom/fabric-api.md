...
有关如何使用数据生成的分步指南，请参阅[数据生成设置](data-generation/setup)页面。 最基本的数据生成设置可以用以下代码来配置： 最基本的数据生成设置可以用以下代码来配置：
...
这将创建一个新的运行配置，运行启用了数据生成的 Fabric API。 可以配置一系列更高级的选项，如下所示： 可以配置一系列更高级的选项，如下所示：
...
这将创建 2 个新的运行配置，一个用于服务器端游戏测试，一个用于客户端游戏测试。 可以配置一系列更高级的选项，如下所示： 可以配置一系列更高级的选项，如下所示：
