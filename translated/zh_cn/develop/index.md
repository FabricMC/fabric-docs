...
- **Fabric API**：一套配套的 API 和工具，供模组开发者在创建模组时使用
- **Fabric Loom**：[Gradle](https://gradle.org/) 插件，使开发者能够轻松开发和调试模组

### Fabric API 能提供什么？ {#what-does-fabric-api-offer}

Fabric API 提供了一系列丰富的 API，这些 API 基于 Fabric 的基本功能构建，支持更高级或更简单的开发。
