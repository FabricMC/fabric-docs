...
:::warning
要使用 Minecraft 1.21.10，你需要安装至少 Java 21。 如果运行该命令后显示 Java 版本低于 21，你需要更新设备上现有 Java。
:::
...
![Java 21 安装程序，其中“Set JAVA_HOME variable”和“JavaSoft (Oracle) registry keys”高亮显示](/assets/players/installing-java/windows-wizard-screenshot.png)
