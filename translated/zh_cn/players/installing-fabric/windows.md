---
title: 在 Windows 上安装 Fabric
description: 在 Windows 上安装 Fabric 的逐步指南。
authors:
  - Benonardo
  - ezfe
  - IMB11
...
从 [Fabric 网站](https://fabricmc.net/use/)下载 Fabric 安装程序的 `.exe` 版本，单击 `Download for Windows`。

:::tip
Windows 版的 `.exe` 程序不需要安装 Java，因为它使用了官方 Minecraft 启动器自带的 Java。
:::
...
如果遇到问题，可随时在 [Fabric Discord](https://discord.gg/v6v4pMv) 的 `#player-support` 频道中寻求帮助。
