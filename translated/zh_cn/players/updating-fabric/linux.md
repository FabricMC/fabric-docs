---
title: 在 Linux 上更新 Fabric
description: 在 Linux 上更新 Fabric 的逐步指南。
authors:
  - IMB11
  - modmuss50
next: false
...
请确保新游戏版本和加载器版本正确，然后单击 `安装` 以更新 Fabric。
...
## 4. 大功告成！ {#4-you-re-done}

完成这些步骤后，就可以回到 `游戏` 选项卡，从左下角的下拉菜单中选择 Fabric 配置文件，然后按下开始游戏！
