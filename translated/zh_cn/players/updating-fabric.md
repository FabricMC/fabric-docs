...
## 为什么应该更新 Fabric Loader？ {#why-should-i-update-fabric-loader} {#why-should-i-update-fabric-loader}
...
安装器完成后，可以打开 Minecraft 启动器并前往 `Installations（安装）` 选项。 您应当前往您的 Fabric 配置并打开编辑界面。 您应当前往您的 Fabric 配置并打开编辑界面。

将该版本替换为刚才安装的 Fabric Loader 版本并点击 `保存`。

![在 Minecraft 启动器中更新 Fabric Loader 版本](/assets/players/updating-fabric.png)

## 4. 搞定！ 搞定！ {#4-you-re-done}
