...
resources:
  https://code.visualstudio.com/: Загрузите Visual Studio Code
  https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack: Пакет расширений для Java - VS Marketplace
---
