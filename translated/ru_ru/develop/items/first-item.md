...
Этот класс позволяет вам настраивать свойства предмета через различные методы. Метод регистрации принимает экземпляр класса `Item.Settings` в качестве параметра.
