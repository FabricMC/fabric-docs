...
Вы можете зарегистрировать свой собственный тип аргумента в методе `onInitialize` инициализатора вашего [мода](../getting-started/project-structure#entrypoints), используя класс `ArgumentTypeRegistry`:
