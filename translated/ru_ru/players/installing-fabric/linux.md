...
## 2. Запустите программу установки Fabric {#2-run-the-fabric-installer}
...
После завершения установки откройте Minecraft Launcher. Затем выберите профиль Fabric в раскрывающемся списке версий и нажмите «Играть».
