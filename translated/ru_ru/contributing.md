...
## <0>new-content</0> Внесение контента {#contributing-content}
...
### 3. <0>stage:verification</0> Проверка содержимого {#3-content-verification}
...
### 4. <0>этап:очистка</0> Очистка {#4-очистка}
